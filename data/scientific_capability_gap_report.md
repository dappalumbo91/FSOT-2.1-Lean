...
| H0_planck | 0.027018411789274284 | 0.8 | 0.773 | MODERATE_LEAD — optional polish | Planck 2018 TT,TE,EE+lowE |
...
- **TOE_GR_SM_Deep**: max 0.4774% med 0.0047% n=97 worst=`glueball_over_sqrt_sigma`

## Thin panels (coverage debt)

- n=1 max=0.10641964500321542  math_generator_benchmark_formula_eval_benchmark.json
