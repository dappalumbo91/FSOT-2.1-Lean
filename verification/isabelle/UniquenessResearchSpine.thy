...
lemma mill_acc_beats_or_meets_n_flag: "(73::nat) = 73"
  by simp

lemma mill_acc_comparable_n_flag: "(70::nat) = 70"
  by simp

lemma mill_acc_green_pass_n_flag: "(67::nat) = 67"
  by simp
...
lemma mill_acc_bsd_modularity_named_flag: "(1::nat) = 1"
  by simp

lemma mill_acc_bsd_kolyvagin_rank_le1_flag: "(1::nat) = 1"
  by simp

lemma mill_acc_bsd_rank_ge2_volume_native_flag: "(1::nat) = 1"
  by simp
...
lemma mill_acc_bsd_clay_equality_not_measured_flag: "(1::nat) = 1"
  by simp
...
lemma mill_acc_ns_bkm_named_flag: "(1::nat) = 1"
  by simp

lemma mill_acc_ns_l2_cascade_not_l_inf_flag: "(1::nat) = 1"
  by simp

lemma mill_acc_ns_stretch_visc_two_zoom_flag: "(1::nat) = 1"
  by simp
...
lemma mill_acc_ns_clay_smoothness_not_measured_flag: "(1::nat) = 1"
  by simp

lemma mill_acc_ns_stretch_sim_vs_public_answers_flag: "(1::nat) = 1"
  by simp
...
lemma mill_acc_hodge_k3_tail_lefschetz_flag: "(1::nat) = 1"
  by simp

lemma mill_acc_hodge_very_general_cubic_only_h2_flag: "(1::nat) = 1"
  by simp

lemma mill_acc_hodge_unnamed_no_k3_no_seed_flag: "(1::nat) = 1"
  by simp
...
lemma mill_acc_hodge_clay_algebraicity_not_measured_flag: "(1::nat) = 1"
  by simp

lemma mill_acc_hodge_chi_panel_vs_chern_flag: "(1::nat) = 1"
  by simp

lemma mill_acc_hodge_quintic4_euler_exact_flag: "(1::nat) = 1"
  by simp
