...
lemma cat_cosmology_anomalies_pooled_under_half_pct: "(0.015148134304819393 :: real) < (0.5 :: real)"
  by eval

lemma cat_cosmology_anomalies_pooled_lt_half_pure: "(0.015148134304819393 :: real) < (0.5 :: real)"
  by eval

lemma cat_cosmology_anomalies_max_scalar_under_half_pct: "(0.34102444848136776 :: real) < (0.5 :: real)"
  by eval
...
lemma cat_pdg_particle_properties_pooled_under_half_pct: "(0.008159790326533337 :: real) < (0.5 :: real)"
  by eval

lemma cat_pdg_particle_properties_pooled_lt_half_pure: "(0.008159790326533337 :: real) < (0.5 :: real)"
  by eval
...
lemma cat_nist_codata_constants_pooled_under_half_pct: "(0.0001803522 :: real) < (0.5 :: real)"
  by eval
...
lemma cat_semiconductor_physics_public_panel_pooled_under_half_pct: "(0 :: real) < (0.5 :: real)"
  by eval
...
lemma cat_higgs_mass_pooled_under_half_pct: "(0.03990518384195136 :: real) < (0.5 :: real)"
  by eval

lemma cat_higgs_mass_pooled_lt_half_pure: "(0.03990518384195136 :: real) < (0.5 :: real)"
  by eval

lemma cat_higgs_mass_max_scalar_under_half_pct: "(0.27079952979037436 :: real) < (0.5 :: real)"
  by eval
...
lemma cat_sh0es_ladder_chain_pooled_under_half_pct: "(0.212101 :: real) < (0.5 :: real)"
  by eval

lemma cat_sh0es_ladder_chain_pooled_lt_half_pure: "(0.212101 :: real) < (0.5 :: real)"
  by eval

lemma cat_sh0es_ladder_chain_max_scalar_under_half_pct: "(0.252234 :: real) < (0.5 :: real)"
  by eval
...
lemma cat_cepheid_pl_interconnect_pooled_under_half_pct: "(0.1349881432328604 :: real) < (0.5 :: real)"
  by eval

lemma cat_cepheid_pl_interconnect_pooled_lt_half_pure: "(0.1349881432328604 :: real) < (0.5 :: real)"
  by eval

lemma cat_cepheid_pl_interconnect_max_scalar_under_half_pct: "(0.2390607110557222 :: real) < (0.5 :: real)"
  by eval

lemma cat_cepheid_pl_interconnect_green_flag: "(1 :: nat) = (1 :: nat)"
  by eval

lemma cat_alternate_base_mathematics_spine_records_pos: "0 < (21 :: nat)"
  by eval

lemma cat_alternate_base_mathematics_spine_pooled_under_half_pct: "(0 :: real) < (0.5 :: real)"
  by eval
