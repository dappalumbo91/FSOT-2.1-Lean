...
Lemma cat_founding_galactic_halo_rotation_panel_pooled_under_half_pct : ((0.000561846%R)) < (0.5%R).
Proof. lra. Qed.


Lemma cat_founding_galactic_halo_rotation_panel_pooled_lt_half_pure : ((0.000561846%R)) < ((0.5%R)).
Proof. lra. Qed.
...
Lemma cat_founding_atmospheric_ozone_panel_pooled_under_half_pct : ((0.000561846%R)) < (0.5%R).
Proof. lra. Qed.


Lemma cat_founding_atmospheric_ozone_panel_pooled_lt_half_pure : ((0.000561846%R)) < ((0.5%R)).
Proof. lra. Qed.
...
Lemma cat_biology_developmental_structural_depth_panel_green_flag : (1 = 1)%nat.
Proof. reflexivity. Qed.
