(* FSOT Tier 80 — FullFormalSpine chunk 13/21 (generated). *)
...
Lemma pubchem_depth_open_pooled_median_under_half_pct : (0.040788%R) < (0.5%R).
Proof. lra. Qed.

Lemma pubchem_depth_open_headline_median_under_half_pct : (0.040788%R) < (0.5%R).
Proof. lra. Qed.
...
Lemma radio_astronomy_panel_median_error_under_half_pct : (0.022461%R) < (0.5%R).
Proof. lra. Qed.

Lemma radio_astronomy_observable_count_pos : (0 < 30)%nat.
Proof. apply Nat.ltb_lt; reflexivity. Qed.

Lemma radio_astronomy_median_error_under_five_pct : (0.022461%R) < (5.0%R).
Proof. lra. Qed.
...
Lemma rcsb_structure_batch_open_pooled_median_under_half_pct : (0.022236%R) < (0.5%R).
Proof. lra. Qed.

Lemma rcsb_structure_batch_open_headline_median_under_half_pct : (0.022236%R) < (0.5%R).
Proof. lra. Qed.
...
Lemma rd_interval_tightening_panel_median_error_under_half_pct : (0.000502%R) < (0.5%R).
Proof. lra. Qed.
...
Lemma robotics_control_systems_panel_median_error_under_half_pct : (0.01341%R) < (0.5%R).
Proof. lra. Qed.
