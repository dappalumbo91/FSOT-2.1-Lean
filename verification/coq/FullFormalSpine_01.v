...
Lemma chaos_pt_pooled_median_under_half_pct : (0.03147898006445882%R) < (0.5%R).
Proof. lra. Qed.

Lemma chaos_pt_headline_median_under_half_pct : (0.03147898006445882%R) < (0.5%R).
Proof. lra. Qed.
...
Lemma chemical_structure_stability_panel_pooled_median_under_half_pct : (0.00206%R) < (0.5%R).
Proof. lra. Qed.

Lemma chemical_structure_stability_panel_headline_median_under_half_pct : (0.0024238898584426276%R) < (0.5%R).
Proof. lra. Qed.
...
Lemma code_genome_pooled_median_under_half_pct : 0%R < (0.5%R).
Proof. lra. Qed.

Lemma code_genome_headline_median_under_half_pct : 0%R < (0.5%R).
Proof. lra. Qed.
