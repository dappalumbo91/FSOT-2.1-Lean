...
Lemma cat_schematic_netlist_intrinsic_panel_records_pos : (0 < 5)%nat.
Proof. apply Nat.ltb_lt; reflexivity. Qed.


Lemma cat_schematic_netlist_intrinsic_panel_pooled_under_half_pct : ((0.051887%R)) < (0.5%R).
Proof. lra. Qed.


Lemma cat_schematic_netlist_intrinsic_panel_pooled_lt_half_pure : ((0.051887%R)) < ((0.5%R)).
Proof. lra. Qed.


Lemma cat_schematic_netlist_intrinsic_panel_max_scalar_under_half_pct : ((0.051887%R)) < (0.5%R).
Proof. lra. Qed.
...
Lemma cat_intelligence_compression_benchmark_json_pooled_under_half_pct : ((0.029066672228905688%R)) < (0.5%R).
Proof. lra. Qed.


Lemma cat_intelligence_compression_benchmark_json_pooled_lt_half_pure : ((0.029066672228905688%R)) < ((0.5%R)).
Proof. lra. Qed.


Lemma cat_intelligence_compression_benchmark_json_max_scalar_under_half_pct : ((0.04959966617804441%R)) < (0.5%R).
Proof. lra. Qed.
...
Lemma cat_optics_interferometry_depth_panel_records_pos : (0 < 127)%nat.
Proof. apply Nat.ltb_lt; reflexivity. Qed.
