(* FSOT scientific catalog spine chunk 13/17 — multi-prover re-proof of domain residual gates. *)
...
Lemma cat_theory_completeness_spine_max_scalar_under_half_pct : ((0.00115123%R)) < (0.5%R).
Proof. lra. Qed.
...
Lemma cat_sh0es_refined_pooled_under_half_pct : (0%R) < (0.5%R).
Proof. lra. Qed.


Lemma cat_sh0es_refined_pooled_lt_half_pure : (0%R) < ((0.5%R)).
Proof. lra. Qed.


Lemma cat_sh0es_refined_max_scalar_under_half_pct : ((0.00111504%R)) < (0.5%R).
Proof. lra. Qed.
...
Lemma cat_toe_claim_certificate_bundle_max_scalar_under_half_pct : ((0.00111504%R)) < (0.5%R).
Proof. lra. Qed.
