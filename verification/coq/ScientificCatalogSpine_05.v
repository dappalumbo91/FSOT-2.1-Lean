...
Lemma cat_fpc_fluidlink_timing_deep_panel_pooled_under_half_pct : ((0.000010883%R)) < (0.5%R).
Proof. lra. Qed.


Lemma cat_fpc_fluidlink_timing_deep_panel_pooled_lt_half_pure : ((0.000010883%R)) < ((0.5%R)).
Proof. lra. Qed.


Lemma cat_fpc_fluidlink_timing_deep_panel_max_scalar_under_half_pct : ((0.039797%R)) < (0.5%R).
Proof. lra. Qed.
...
Lemma cat_energy_lean_route_credibility_records_pos : (0 < 40)%nat.
Proof. apply Nat.ltb_lt; reflexivity. Qed.


Lemma cat_energy_lean_route_credibility_pooled_under_half_pct : ((0.039349%R)) < (0.5%R).
Proof. lra. Qed.


Lemma cat_energy_lean_route_credibility_pooled_lt_half_pure : ((0.039349%R)) < ((0.5%R)).
Proof. lra. Qed.
