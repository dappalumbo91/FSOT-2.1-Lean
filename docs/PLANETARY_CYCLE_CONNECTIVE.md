...
`neighbor_kinds` on **new** issues only. Fold operator + frozen
potentials: [`DYNAMIC_SYSTEM_TRIANGULATION.md`](DYNAMIC_SYSTEM_TRIANGULATION.md).

Related: [`WEATHER_MONITORING_APPROACH.md`](WEATHER_MONITORING_APPROACH.md) ·
[`CONCEPTS.md`](CONCEPTS.md) C1/C2/C10/C14 ·
[`DYNAMIC_SYSTEM_TRIANGULATION.md`](DYNAMIC_SYSTEM_TRIANGULATION.md) ·
