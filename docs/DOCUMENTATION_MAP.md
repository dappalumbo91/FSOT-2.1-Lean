...
| **Accuracy vs public SOTA** | [`MILLENNIUM_ACCURACY_VS_SOTA.md`](MILLENNIUM_ACCURACY_VS_SOTA.md) | Function contest, not Prize gates | Named Hodge \(C_8\)..\(C_{44}\); BSD ranks 0..4; rank 0..4 vanishing |
