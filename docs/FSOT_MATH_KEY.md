...
| Margin-audit green benchmarks | `green_gate_pass_count` / `benchmark_file_count` | see CURRENT_STATUS (live **477/477**) |
| Scalar-record envelope | status snapshot | see CURRENT_STATUS |
| Scientific catalog obligations | `verification/obligations/scientific_catalog_spine.json` | live **2256** (see CURRENT_STATUS) |
| Full formal spine obligations | `verification/obligations/full_formal_spine.json` | **2587** |
