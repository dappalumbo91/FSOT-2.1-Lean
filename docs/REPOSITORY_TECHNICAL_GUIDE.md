# FSOT Repository Technical Guide

> **Note:** The repository front door is now the thesis in [`README.md`](../README.md).  
> This file preserves the module index, tier registry, and contributor commands.
