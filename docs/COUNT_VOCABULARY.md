...
|------|------------------------:|----------------|--------|
| **Green residual benchmarks** | **472 / 472** | Benchmark **files** that pass ≤0.5% pooled median (`B_verified` 330 · `C_thin` 17 · `A_strong` 116) | `data/benchmark_margin_audit.json` |
...
| **Catalog obligations** | **2228** | Scientific-catalog spine (472 domains) | same |
