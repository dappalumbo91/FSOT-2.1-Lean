...
| Millennium BSD vs FSOT | [`MILLENNIUM_BSD_VS_FSOT.md`](MILLENNIUM_BSD_VS_FSOT.md) — question: rank vs ord \(L\); answer: first-of-rank 0..4; LMFDB ranks 0..5 vanishing complete |
