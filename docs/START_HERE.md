...
| Millennium BSD vs FSOT | [`MILLENNIUM_BSD_VS_FSOT.md`](MILLENNIUM_BSD_VS_FSOT.md) — question: rank vs ord \(L\); answer: first-of-rank 0..4; rank 0..5 vanishing not magnitude |
