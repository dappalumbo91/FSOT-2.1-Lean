# FSOT Practical Pipeline

*What comes down the pipeline · 2026-07-16 · [Main thesis](../README.md)*
...
**35 preregistered predictions** locked in `data/preregistered_predictions_manifest.yaml` (PRED-001–041).
...
Desktop project: **validators_intrinsic_llm**

### Embodied Sensing

Panels: `Living_FSOT_Hardware_Panel`, `Trinary_Hardware_Live_Panel`

*QEMU + desktop observer loop — not ESP32*
...
- reproducible without vendor lock in
- verification before marketing claims
