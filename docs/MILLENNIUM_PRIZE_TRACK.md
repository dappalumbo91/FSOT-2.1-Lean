...
| **Hodge conjecture** | Hodge classes on a projective complex manifold are algebraic cycles (rational) | Lefschetz; associated K3; \(C_8\) extra class is \([\mathrm{plane}]\), algebraic. Remainder: other extra discriminants, general 4-folds. | Native **probe**. Clay **OPEN_NOT_CLAIMED** |
