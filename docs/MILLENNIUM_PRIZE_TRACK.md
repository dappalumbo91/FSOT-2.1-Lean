...
| **BSD** | Is \(\mathrm{rank}\,E(\mathbb{Q})=\mathrm{ord}_{s=1}L(E,s)\)? | Parity from \(w_E\). First-of-rank 0..4. Rank 0..5 are vanishing order (17a1/53a1/643a1/11197a1/501029.a1/19047851.a1 Sha=1, not leading magnitudes). | \(\mathrm{ord}\,L\) for rank \(\ge 6\) |
