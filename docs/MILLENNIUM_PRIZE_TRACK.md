...
| **BSD** | Is \(\mathrm{rank}\,E(\mathbb{Q})=\mathrm{ord}_{s=1}L(E,s)\)? | Parity from \(w_E\). First-of-rank 0..4. Rank 0/1/2/3 are vanishing order (17a1/53a1/643a1/11197a1 Sha=1, not leading magnitudes). | \(\mathrm{ord}\,L\) for rank \(\ge 4\) |
...
| **Birch and Swinnerton-Dyer** | Rank of \(E(\mathbb{Q})\) equals order of vanishing of \(L(E,s)\) at \(s=1\) | Parity from \(w_E\). First-of-rank leadings 0..4. Rank 0..3 vanishing not magnitude. \(\mathrm{Reg}(234446a1)=(\varphi^2+1)\cdot e\cdot\mathrm{POOF}\). General \(E\) still needs \(\mathrm{ord}\,L\). | Native **probe**. Clay **OPEN_NOT_CLAIMED** |
