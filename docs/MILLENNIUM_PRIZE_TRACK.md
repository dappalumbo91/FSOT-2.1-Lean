...
| **Birch and Swinnerton-Dyer** | Rank of \(E(\mathbb{Q})\) equals order of vanishing of \(L(E,s)\) at \(s=1\) | Parity from \(w_E\). \(L''(389a1,1)/2!=2\pi\mathrm{POOF}/\sqrt{\varphi}\). Integer rank still needs \(\mathrm{ord}\,L\). | Native **probe**. Clay **OPEN_NOT_CLAIMED** |
