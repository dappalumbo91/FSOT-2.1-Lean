...
| **BSD** | Is \(\mathrm{rank}\,E(\mathbb{Q})=\mathrm{ord}_{s=1}L(E,s)\)? | Parity from \(w_E\). First-of-rank 0..4. LMFDB ranks 0..5 vanishing (Sha=1). Rank \(\ge 6\) unnamed tail (outside LMFDB). | General \(E\) without the modular form |
