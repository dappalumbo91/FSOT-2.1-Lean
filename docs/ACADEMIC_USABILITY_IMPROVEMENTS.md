...
README headlines and generators now follow [`COUNT_VOCABULARY.md`](COUNT_VOCABULARY.md): **477/477** green files vs ~407 named domains vs **2024** atomic. Do not re-introduce 394/405/432 as the live gate.
