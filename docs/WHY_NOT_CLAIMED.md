...
| A SOTA beat as 0.5% green | Riemann n=2..10 locked-\(C\) (1.63%) and glueball \(\varphi^2+1\) vs Teper 1997 (0.876%) **beat the σ-unit competitor** and are **outside** the rest-of-system 0.5% gate. | Marked `beats_sota_fsot_accuracy_wip`. Do not stuff. |
