...
| A SOTA beat as 0.5% green | Riemann n=2..10 locked-\(C\) point-T (1.63%) is GUE jitter vs smooth counting — Odlyzko sits in the 1/e Gram band. Glueball \(\varphi^2+1\) vs Teper 1997 (0.876%) is σ-units. | Do not stuff the point residual. Band occupancy is the named leftover. |
