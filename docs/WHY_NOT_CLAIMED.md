...
| A SOTA beat as 0.5% green | Riemann n=2..10 locked-\(C\) (1.63%) and glueball \(\varphi^2+1\) vs Teper 1997 (0.876%) **beat the dated competitor** and are **outside** the rest-of-system 0.5% gate. | Marked `beats_sota_fsot_accuracy_wip`. Do not stuff. |
| Glueball \(m(0^{++})/\sqrt{\sigma}\) vs live lattice | AT2020 SU(3) continuum is **3.405(21)** (arXiv:2007.06422). Seed \(\varphi^2+1=3.618\) is **6.26%** (outside 1σ). 1997 3.65±0.11 is the dated construct (inside 1σ). | Did not keep 1997 because it was greener. Did not retune \(\varphi^2+1\). Not a particle. |
