...
| Glueball \(m(0^{++})/\sqrt{\sigma}\) beating Teper lattice | Live compare vs 3.65±0.11 **does not beat**. Do not retune the 3.5 ballpark. | Recorded miss on that function. Λ_QCD and first-zero closed form are separate rows. |
