...
| Identifying the scalar glueball with \(f_0(1500)\) or \(f_0(1710)\) | Two orifices: gluonic \((\varphi^2+1)K\) vs \(f_0(1500)\) (0.93% WIP); flavor \((\pi+1)K\) vs \(f_0(1710)\) (0.40% green). Morningstar 2025: neither below ~2 GeV is predominantly glue. | Named both PDG \(I=0\) \(0^{++}\) states. Did not retune \(K\). Did not swap. |
