#!/usr/bin/env python3
"""Generate Lean priors for Tier 72 periodic table domains."""
...
DOMAIN_CONFIG: dict[str, tuple[str, str, int, str]] = {
    "Periodic_Table_Public_Panel": ("periodic_table_public_panel", "PeriodicTablePublicPanelPriors", 9, "periodic_table_public_panel_benchmark.json"),
    "Superheavy_Element_Stability_Panel": ("superheavy_element_stability_panel", "SuperheavyElementStabilityPanelPriors", 10, "superheavy_element_stability_panel_benchmark.json"),
    "Undiscovered_Element_Candidate_Prereg_Scaffold": ("undiscovered_element_candidate_prereg_scaffold", "UndiscoveredElementCandidatePreregScaffoldPriors", 10, "undiscovered_element_candidate_prereg_scaffold_benchmark.json"),
    "Natural_Formation_Element_Simulation": ("natural_formation_element_simulation", "NaturalFormationElementSimulationPriors", 11, "natural_formation_element_simulation_benchmark.json"),
    "Periodic_Table_Completion_Spine": ("periodic_table_completion_spine", "PeriodicTableCompletionSpinePriors", 12, "periodic_table_completion_spine_benchmark.json"),
}
...
def build_lean(bench: dict, prefix: str, module_stem: str, d_eff: int) -> str:
    ...
    return f"""/-
  FSOT Formal {module_stem} — Tier 72 periodic table completion.
