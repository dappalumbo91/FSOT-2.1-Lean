#!/usr/bin/env python3
"""Generate FSOT/Formal/FormulaCorpusCncPriors.lean."""
...
MANIFEST = ROOT / "data" / "formula_corpus_cnc_manifest.yaml"
BENCH = ROOT / "data" / "formula_corpus_cnc_benchmark.json"
OUTPUT = ROOT / "FSOT" / "Formal" / "FormulaCorpusCncPriors.lean"
...
def main() -> int:
    ...
    text = extension_priors_lean(
        module_title="FSOT Formal FormulaCorpusCncPriors — Formula corpus + CNC controller bundle.",
        generator="scripts/gen_formula_corpus_cnc_lean.py",
        prefix="formula_corpus_cnc",
