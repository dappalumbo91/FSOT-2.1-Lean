#!/usr/bin/env python3
"""Generate FSOT/Formal/CertifiedAgentQwenPriors.lean."""
...
MANIFEST = ROOT / "data" / "certified_agent_qwen_manifest.yaml"
BENCH = ROOT / "data" / "certified_agent_qwen_benchmark.json"
OUTPUT = ROOT / "FSOT" / "Formal" / "CertifiedAgentQwenPriors.lean"
...
def main() -> int:
    ...
    text = extension_priors_lean(
        module_title="FSOT Formal CertifiedAgentQwenPriors — Qwen certified formal agent crosswalk.",
        generator="scripts/gen_certified_agent_qwen_lean.py",
        prefix="certified_agent_qwen",
