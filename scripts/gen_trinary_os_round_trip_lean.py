#!/usr/bin/env python3
"""Generate FSOT/Formal/TrinaryOSRoundTripPriors.lean."""
...
BENCH = ROOT / "data" / "trinary_os_round_trip_benchmark.json"
OUTPUT = ROOT / "FSOT" / "Formal" / "TrinaryOSRoundTripPriors.lean"
...
def main() -> int:
    ...
    text = extension_priors_lean(
        module_title="FSOT Formal TrinaryOSRoundTripPriors — FSOTB round-trip rebuild smoke.",
        generator="scripts/gen_trinary_os_round_trip_lean.py",
        prefix="trinary_os_round_trip",
