#!/usr/bin/env python3
"""Generate FSOT/Formal/ComputationalReasoningPriors.lean."""
...
BENCH = ROOT / "data" / "computational_reasoning_benchmark.json"
OUTPUT = ROOT / "FSOT" / "Formal" / "ComputationalReasoningPriors.lean"
...
def main() -> int:
    ...
    text = extension_priors_lean(
        module_title="FSOT Formal ComputationalReasoningPriors — FIC sweep + trinary-OS invariants.",
        generator="scripts/gen_computational_reasoning_lean.py",
        prefix="computational_reasoning",
