#!/usr/bin/env python3
"""Generate Lean priors for Tier 93 dual wave panels."""
...
from tier93_dual_wave_lib import BUILDERS, LEAN_MAP, output_path  # noqa: E402
...
def main() -> int:
    ...
    for domain in args.only or sorted(BUILDERS.keys()):
        ...
        text = extension_priors_lean(
            module_title=f"FSOT Formal {module_stem} — Tier 93 dual wave ({domain}).",
            generator="scripts/gen_tier93_dual_wave_lean.py",
            prefix=prefix,
