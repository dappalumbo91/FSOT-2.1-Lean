#!/usr/bin/env python3
"""Generate Lean priors for Tier 66 NeuroLab residual domains."""
...
DOMAIN_CONFIG: dict[str, tuple[str, str, int, str]] = {
    ...
    "Econophysics": (
        ...
        "EconophysicsPriors",
        20,
        "econophysics_benchmark.json",
    ),
    "Ecology": (
        "ecology",
        "EcologyPublicPanelPriors",
        15,
        "ecology_benchmark.json",
    ),
    "Genomic_Sciences": (
        "genomic_sciences",
        "GenomicSciencesPriors",
        12,
        "genomic_sciences_benchmark.json",
    ),
    "Neurolab_Residual_Math_Spine": (
        "neurolab_residual_math_spine",
        "NeurolabResidualMathSpinePriors",
        17,
        "neurolab_residual_math_spine_benchmark.json",
    ),
}
...
def build_lean(bench: dict, prefix: str, module_stem: str, d_eff: int) -> str:
    ...
    return f"""/-
  FSOT Formal {module_stem} — Tier 66 NeuroLab residual registry panels.
