#!/usr/bin/env python3
"""Generate FSOT/Formal/LinguisticsFormalPriors.lean."""
...
BENCH = ROOT / "data" / "linguistics_formal_benchmark.json"
OUTPUT = ROOT / "FSOT" / "Formal" / "LinguisticsFormalPriors.lean"
...
def main() -> int:
    ...
    text = extension_priors_lean(
        module_title="FSOT Formal LinguisticsFormalPriors — measured linguistic anchors.",
        generator="scripts/gen_linguistics_formal_lean.py",
        prefix="linguistics_formal",
