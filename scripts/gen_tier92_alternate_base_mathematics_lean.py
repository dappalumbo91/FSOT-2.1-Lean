#!/usr/bin/env python3
"""Generate Lean priors for Tier 92 alternate base mathematics panels."""
...
from tier92_alternate_base_mathematics_lib import BUILDERS, LEAN_MAP, output_path  # noqa: E402
...
def main() -> int:
    ...
    for domain in args.only or sorted(BUILDERS.keys()):
        ...
        text = extension_priors_lean(
            module_title=f"FSOT Formal {module_stem} — Tier 92 alternate base math ({domain}).",
            generator="scripts/gen_tier92_alternate_base_mathematics_lean.py",
            prefix=prefix,
