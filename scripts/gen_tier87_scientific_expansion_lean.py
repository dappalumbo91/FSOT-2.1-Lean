#!/usr/bin/env python3
"""Generate Lean priors for Tier 87 scientific domain expansion panels."""
...
from tier87_scientific_expansion_lib import BUILDERS, LEAN_MAP, output_path  # noqa: E402
...
def main() -> int:
    ...
    for domain in args.only or sorted(BUILDERS.keys()):
        ...
        text = extension_priors_lean(
            module_title=f"FSOT Formal {module_stem} — Tier 87 depth wave ({domain}).",
