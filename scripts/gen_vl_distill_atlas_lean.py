#!/usr/bin/env python3
"""Generate FSOT/Formal/VlDistillAtlasPriors.lean."""
...
MANIFEST = ROOT / "data" / "vl_distill_atlas_manifest.yaml"
BENCH = ROOT / "data" / "vl_distill_atlas_benchmark.json"
OUTPUT = ROOT / "FSOT" / "Formal" / "VlDistillAtlasPriors.lean"
...
def main() -> int:
    ...
    text = extension_priors_lean(
        module_title="FSOT Formal VlDistillAtlasPriors — VL distill atlas + domain registry crosswalk.",
        generator="scripts/gen_vl_distill_atlas_lean.py",
        prefix="vl_distill_atlas",
