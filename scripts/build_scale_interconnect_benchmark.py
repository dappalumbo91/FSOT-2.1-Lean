...
def main() -> int:
    ...
    doc = _bench_v11(
        ...
        source=[
            ...
            "GBIF occurrence decimalLatitude (ecology_gap_fill, gbif_api)",
            "Nunnally 1978 / Cohen 1988 psychometric anchors (measured column only)",
    ...
    doc["gap_fill"] = {
        ...
        "qc_ac": "QC stays dark. Dark same-look D=10/11. CRC c vs n. Compactification remainder not stuffed.",
        "qc_mat": "QC stays dark. CRC ρ vs n.",
        "qc_opt": "QC stays dark. CRC n dual-route.",
        "qc_qo": "QC stays dark. CRC n. Live vs 1 is observed mix.",
        "qc_bio": "Both dark. CRC n vs NCBI mt-operon.",
        "cm_eco": "Ecology stays dark. CRC metal ρ + GBIF latitude. No invented watts.",
        "neuro_eco": "Ecology stays dark. Transmitter AA + GBIF latitude.",
        "eco_fluid": "Both dark. GBIF latitude + CRC water ρ.",
        "eco_nuc": "Ecology stays dark. GBIF latitude + ENDF keV.",
        "eco_thermo": "Ecology stays dark. GBIF latitude + Carnot.",
        "eco_meteo": "Both dark. GBIF latitude + NDBC pressure.",
        "eco_psych": "Ecology stays dark. GBIF + Nunnally/Cohen. Not watts.",
        "fluid_psych": "Fluid stays dark. CRC water + Nunnally/Cohen. Not watts.",
        "nuc_psych": "ENDF keV + Nunnally/Cohen. Not watts.",
        "thermo_psych": "Carnot + Nunnally/Cohen. Not watts.",
        "meteo_psych": "Meteo stays dark. NDBC pressure + Nunnally/Cohen.",
