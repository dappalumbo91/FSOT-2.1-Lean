#!/usr/bin/env python3
"""Generate FSOT/Formal/TrinaryHardwareMotifPriors.lean."""
...
MANIFEST = ROOT / "data" / "trinary_hardware_motif_manifest.yaml"
BENCH = ROOT / "data" / "trinary_hardware_motif_benchmark.json"
OUTPUT = ROOT / "FSOT" / "Formal" / "TrinaryHardwareMotifPriors.lean"
...
def main() -> int:
    ...
    text = extension_priors_lean(
        module_title="FSOT Formal TrinaryHardwareMotifPriors — cube-block motif profile invariants.",
        generator="scripts/gen_trinary_hardware_motif_lean.py",
        prefix="trinary_hardware_motif",
