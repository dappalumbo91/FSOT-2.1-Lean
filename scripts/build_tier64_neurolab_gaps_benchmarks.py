#!/usr/bin/env python3
"""Build Tier 64 NeuroLab gap panels + spine."""
...
from tier64_neurolab_gaps_lib import BUILDERS, BUILD_ORDER, output_path  # noqa: E402
...
def main() -> int:
    ...
    if "Neurolab_Gaps_Math_Spine" in domains:
        prereqs = [d for d in BUILD_ORDER if d != "Neurolab_Gaps_Math_Spine"]
