...
DESKTOP_FOLDERS: list[dict] = [
    {"name": "FSOT, Cube Block Trinary Design", "theme": "trinary_hardware", "lean_lab": "trinary_hardware_live_lab"},
    {"name": "New folder", "theme": "thesis_simulation", "lean_lab": "thesis_simulation_lab"},
    {"name": "Fluid spacetime omni-theory, FSOT, and the Holy Bible", "theme": "omni_theory_humanities", "lean_lab": "omni_theory_humanities_lab"},
    {"name": "New folder (2)", "theme": "validators_intrinsic_llm", "lean_lab": "validators_intrinsic_llm_lab"},
    ...
    {"name": "FSOTLean", "theme": "early_lean_mc", "lean_lab": "early_lean_mc_lab"},
    {"name": "New folder (6)", "theme": "bibliography", "lean_lab": "bibliography_corpus_lab"},
    {"name": "Fsot trinary", "theme": "trinary_os", "lean_lab": "trinary_os"},
    {"name": "FSOT linguistics", "theme": "linguistics", "lean_lab": "linguistics_lab"},
    {"name": "Dictionary", "theme": "tokenization", "lean_lab": "tokenization_live_lab"},
    {"name": "fsot QWEN 3VL_Formal_Env", "theme": "certified_agent", "lean_lab": "certified_agent_formal_lab"},
    ...
    {"name": "fsot qwen 3vl", "theme": "vl_agent", "lean_lab": "vl_agent_lab"},
    {"name": "gemma-4-", "theme": "model_weights", "lean_lab": None},
    {"name": "FSOT SMILES Lab", "theme": "physical_constants", "lean_lab": "smiles_lab"},
    {"name": "fsot_rendlesham_page_decoder ailen code", "theme": "binary_decoder", "lean_lab": "binary_decoder_lab"},
    ...
    {"name": "Physarum polycephalum,", "theme": "biological_cuda", "lean_lab": "biological_cuda_lab"},
    ...
    {"name": "Brain", "theme": "arxiv_brain", "lean_lab": "arxiv_brain_lab"},
    {"name": "FSOT_3_5", "theme": "scalar_solver", "lean_lab": "scalar_solver_lab"},
    {"name": "loop", "theme": "arxiv_primitives", "lean_lab": "arxiv_primitives_lab"},
    ...
    {"name": "New folder (7)", "theme": "rust_lean_bridge", "lean_lab": "rust_lean_bridge_lab"},
    {"name": "nuron lean", "theme": "empty", "lean_lab": None},
    {"name": "FSOT-2.1-Lean-main", "theme": "formal_verification_hub", "lean_lab": None},
    {"name": "living fsot", "theme": "living_fsot_hardware", "lean_lab": "living_fsot_hardware_lab"},
    {"name": "FSOT Photonic V2 Experiments", "theme": "photonics", "lean_lab": "photonic_forge"},
    {"name": "FSOT document update", "theme": "canonical_oracle", "lean_lab": "canonical_oracle_lab"},
...
THEME_LABELS = {
    ...
    "living_fsot_hardware": "Living FSOT — QEMU trinary body + Rust mind gym",
