#!/usr/bin/env python3
"""Generate Lean priors for Tier 79 STScI MAST telescope panel."""
...
from stsci_mast_lib import BUILDERS, LEAN_MAP, output_path  # noqa: E402
...
def main() -> int:
    ...
    for domain in args.only or sorted(BUILDERS.keys()):
        ...
        text = extension_priors_lean(
            module_title=f"FSOT Formal {module_stem} — Tier 79 STScI MAST ({domain}).",
