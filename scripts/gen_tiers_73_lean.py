#!/usr/bin/env python3
"""Generate Lean priors for Tier 73 lab synthesis + metamaterial domains."""
...
DOMAIN_CONFIG: dict[str, tuple[str, str, int, str]] = {
    "Heavy_Ion_Lab_Synthesis_Panel": ("heavy_ion_lab_synthesis_panel", "HeavyIonLabSynthesisPanelPriors", 13, "heavy_ion_lab_synthesis_panel_benchmark.json"),
    "Element_Synthesis_Condition_Scaffold": ("element_synthesis_condition_scaffold", "ElementSynthesisConditionScaffoldPriors", 14, "element_synthesis_condition_scaffold_benchmark.json"),
    "Cold_Fusion_Lab_Synthesis_Crosswalk": ("cold_fusion_lab_synthesis_crosswalk", "ColdFusionLabSynthesisCrosswalkPriors", 15, "cold_fusion_lab_synthesis_crosswalk_benchmark.json"),
    "Metamaterial_Fluid_Design_Prereg_Scaffold": ("metamaterial_fluid_design_prereg_scaffold", "MetamaterialFluidDesignPreregScaffoldPriors", 16, "metamaterial_fluid_design_prereg_scaffold_benchmark.json"),
    "Lab_Synthesis_Metamaterial_Spine": ("lab_synthesis_metamaterial_spine", "LabSynthesisMetamaterialSpinePriors", 18, "lab_synthesis_metamaterial_spine_benchmark.json"),
}
...
def build_lean(bench: dict, prefix: str, module_stem: str, d_eff: int) -> str:
    ...
    return f"""/-
  FSOT Formal {module_stem} — Tier 73 lab synthesis + metamaterial fluid design.
