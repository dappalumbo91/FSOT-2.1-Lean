#!/usr/bin/env python3
"""Generate Lean priors for Tier 90 consciousness expansion panels."""
...
from tier90_consciousness_expansion_lib import BUILDERS, LEAN_MAP, output_path  # noqa: E402
...
def main() -> int:
    ...
    for domain in args.only or sorted(BUILDERS.keys()):
        ...
        text = extension_priors_lean(
            module_title=f"FSOT Formal {module_stem} — Tier 90 consciousness expansion ({domain}).",
            generator="scripts/gen_tier90_consciousness_expansion_lean.py",
            prefix=prefix,
