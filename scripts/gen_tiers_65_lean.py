#!/usr/bin/env python3
"""Generate Lean priors for Tier 65 prereg screening scaffolds."""
...
DOMAIN_CONFIG: dict[str, tuple[str, str, int, str]] = {
    "Material_In_Silico_Screening_Scaffold": (
        "material_in_silico_screening_scaffold",
        "MaterialInSilicoScreeningScaffoldPriors",
        15,
        "material_in_silico_screening_scaffold_benchmark.json",
    ),
    "Fuel_Candidate_Prereg_Scaffold": (
        "fuel_candidate_prereg_scaffold",
        "FuelCandidatePreregScaffoldPriors",
        16,
        "fuel_candidate_prereg_scaffold_benchmark.json",
    ),
    "Interactive_Media_Prereg_Scaffold": (
        "interactive_media_prereg_scaffold",
        "InteractiveMediaPreregScaffoldPriors",
        14,
        "interactive_media_prereg_scaffold_benchmark.json",
    ),
}
...
def build_lean(bench: dict, prefix: str, module_stem: str, d_eff: int) -> str:
    ...
    return f"""/-
  FSOT Formal {module_stem} — Tier 65 prereg screening scaffolds (public methodology gates).
