#!/usr/bin/env python3
"""Build Tier 67 formula precision panels + spine."""
...
from tier67_formula_precision_lib import BUILDERS, BUILD_ORDER, output_path  # noqa: E402
...
def main() -> int:
    ...
    if "Formula_Precision_Spine" in domains:
        prereqs = [d for d in BUILD_ORDER if d != "Formula_Precision_Spine"]
