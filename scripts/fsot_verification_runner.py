...
def main() -> int:
    ...
    if ingest.exists():
        ...
        tier5_ingests = [
            ...
            ("ingest_cosmology_bubble_bleed_lab.py", "gen_bubble_bleed_priors_lean.py", "BubbleBleedPriors.lean generation failed", "cosmology bubble bleed ingest failed"),
        ...
        for verify_name, fail_msg in (
            ...
            ("build_fsot_label_registry.py", "FSOT label registry build failed"),
            ("enrich_benchmark_scientific_metadata.py", "Benchmark scientific metadata enrichment failed"),
            ("build_verification_depth_audit.py", "Verification depth audit failed"),
        ...
        if rebuild:
            for bench_script in (
                ...
                "build_intelligence_compression_benchmark.py",
            ...
            ("ingest_cosmology_higher_waves.py", "gen_cosmology_higher_waves_lean.py", "CosmologyHigherWavesPriors.lean generation failed", "cosmology higher waves ingest failed"),
            ...
            ("ingest_higgs_mass_lab.py", "gen_higgs_mass_lean.py", "HiggsMassPriors.lean generation failed", "higgs mass ingest failed"),
            ...
            ("ingest_seismology_usgs.py", "gen_seismology_lean.py", "SeismologyPriors.lean generation failed", "seismology USGS ingest failed"),
            ("ingest_tectonics_plates.py", "gen_tectonics_lean.py", "TectonicsPriors.lean generation failed", "tectonics plate ingest failed"),
