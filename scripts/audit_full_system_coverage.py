...
FIELD_BREADTH: dict[str, dict] = {
    ...
    "Optics": {"studied_subfields": 9, "touched": 2, "note": "MAST wavelengths; thin on interferometry, nonlinear optics"},
    "Acoustics": {"studied_subfields": 7, "touched": 2, "note": "SMILES relay; thin on sonar, architectural acoustics"},
    "Quantum_Computing": {"studied_subfields": 8, "touched": 2, "note": "Classifier/scaffold; thin on gate fidelity, error correction"},
    ...
    "Neuroscience": {"studied_subfields": 15, "touched": 5, "note": "OpenNeuro/neuron cohort; thin on connectomics, fMRI meta"},
    "Condensed_Matter": {"studied_subfields": 14, "touched": 4, "note": "Materials/quantum materials; thin on superconductivity Tc"},
