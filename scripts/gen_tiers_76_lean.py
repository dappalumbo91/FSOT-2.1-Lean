#!/usr/bin/env python3
"""Generate Lean priors for Tier 76 fluid spacetime + cosmology deepening."""
...
DOMAIN_CONFIG: dict[str, tuple[str, str, int, str]] = {
    "Time_Emergence_Deep_Panel": ("time_emergence_deep_panel", "TimeEmergenceDeepPanelPriors", 19, "time_emergence_deep_panel_benchmark.json"),
    "FPC_Fluidlink_Timing_Deep_Panel": ("fpc_fluidlink_timing_deep_panel", "FpcFluidlinkTimingDeepPanelPriors", 20, "fpc_fluidlink_timing_deep_panel_benchmark.json"),
    "Cosmology_Anomaly_Deep_Panel": ("cosmology_anomaly_deep_panel", "CosmologyAnomalyDeepPanelPriors", 24, "cosmology_anomaly_deep_panel_benchmark.json"),
    "Hubble_Dark_Sector_Crosswalk": ("hubble_dark_sector_crosswalk", "HubbleDarkSectorCrosswalkPriors", 25, "hubble_dark_sector_crosswalk_benchmark.json"),
    "Fluid_Spacetime_Observable_Spine": ("fluid_spacetime_observable_spine", "FluidSpacetimeObservableSpinePriors", 26, "fluid_spacetime_observable_spine_benchmark.json"),
}
...
def build_lean(bench: dict, prefix: str, module_stem: str, d_eff: int) -> str:
    ...
    return f"""/-
  FSOT Formal {module_stem} — Tier 76 fluid spacetime + cosmology.
