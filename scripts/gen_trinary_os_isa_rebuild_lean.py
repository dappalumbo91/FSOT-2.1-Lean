#!/usr/bin/env python3
"""Generate FSOT/Formal/TrinaryOSISARebuildPriors.lean."""
...
BENCH = ROOT / "data" / "trinary_os_isa_rebuild_benchmark.json"
OUTPUT = ROOT / "FSOT" / "Formal" / "TrinaryOSISARebuildPriors.lean"
...
def main() -> int:
    ...
    text = extension_priors_lean(
        module_title="FSOT Formal TrinaryOSISARebuildPriors — full FSOTB ISA rebuild from vendor bundle.",
        generator="scripts/gen_trinary_os_isa_rebuild_lean.py",
        prefix="trinary_os_isa_rebuild",
