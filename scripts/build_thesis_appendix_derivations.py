...
def build(ts: str) -> str:
    ...
    parts = [
        ...
        "```",
        "",
        "Live FSOT **20.003601 W vs 20.0 W (0.018%)** — Homo sapiens `brain_power_w` "
        "in `consciousness_species_multi_panel_benchmark.json` (Clarke & Sokoloff / AnAge). "
        "The 2025 draft 21.79 W / 8.95% is retired. "
