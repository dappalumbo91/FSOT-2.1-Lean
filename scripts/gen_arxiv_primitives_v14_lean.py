#!/usr/bin/env python3
"""Generate FSOT/Formal/ArxivPrimitivesV14Priors.lean."""
...
MANIFEST = ROOT / "data" / "arxiv_primitives_v14_manifest.yaml"
BENCH = ROOT / "data" / "arxiv_primitives_v14_benchmark.json"
OUTPUT = ROOT / "FSOT" / "Formal" / "ArxivPrimitivesV14Priors.lean"
...
def main() -> int:
    ...
    text = extension_priors_lean(
        module_title="FSOT Formal ArxivPrimitivesV14Priors — arXiv V14 cognitive primitives loop.",
        generator="scripts/gen_arxiv_primitives_v14_lean.py",
        prefix="arxiv_primitives_v14",
