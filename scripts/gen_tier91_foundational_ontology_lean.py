#!/usr/bin/env python3
"""Generate Lean priors for Tier 91 foundational ontology panels."""
...
from tier91_foundational_ontology_lib import BUILDERS, LEAN_MAP, output_path  # noqa: E402
...
def main() -> int:
    ...
    for domain in args.only or sorted(BUILDERS.keys()):
        ...
        text = extension_priors_lean(
            module_title=f"FSOT Formal {module_stem} — Tier 91 foundational ontology ({domain}).",
            generator="scripts/gen_tier91_foundational_ontology_lean.py",
            prefix=prefix,
