#!/usr/bin/env python3
"""Generate Lean priors for Tier 71 fusion lab domains."""
...
DOMAIN_CONFIG: dict[str, tuple[str, str, int, str]] = {
    "Fusion_Physics_Public_Panel": ("fusion_physics_public_panel", "FusionPhysicsPublicPanelPriors", 18, "fusion_physics_public_panel_benchmark.json"),
    "Magnetic_Confinement_Fusion_Panel": ("magnetic_confinement_fusion_panel", "MagneticConfinementFusionPanelPriors", 16, "magnetic_confinement_fusion_panel_benchmark.json"),
    "Inertial_Confinement_Fusion_Panel": ("inertial_confinement_fusion_panel", "InertialConfinementFusionPanelPriors", 17, "inertial_confinement_fusion_panel_benchmark.json"),
    "Cold_Fusion_Candidate_Prereg_Scaffold": ("cold_fusion_candidate_prereg_scaffold", "ColdFusionCandidatePreregScaffoldPriors", 14, "cold_fusion_candidate_prereg_scaffold_benchmark.json"),
    "Fusion_Lab_Certificate_Spine": ("fusion_lab_certificate_spine", "FusionLabCertificateSpinePriors", 20, "fusion_lab_certificate_spine_benchmark.json"),
}
...
def build_lean(bench: dict, prefix: str, module_stem: str, d_eff: int) -> str:
    ...
    return f"""/-
  FSOT Formal {module_stem} — Tier 71 fusion lab expansion.
