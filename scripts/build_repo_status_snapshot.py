...
def write_md(doc: dict) -> str:
    ...
    lines = [
        ...
        "| Item | Value |",
        "|------|-------|",
        f"| Pin match | **{auth['pin_match']}** |",
        f"| Multiprover overall_ok | see below |",
        ...
        f"- D11 orifice-scale triangulation: [`DYNAMIC_SYSTEM_TRIANGULATION.md`](DYNAMIC_SYSTEM_TRIANGULATION.md)",
        f"- Uniqueness attractor Lean (not YM path-integral): [`UNIQUENESS_RESEARCH_SPINE.md`](UNIQUENESS_RESEARCH_SPINE.md)",
        f"- Materials/fuels design sibling: https://github.com/dappalumbo91/FSOT-Materials",
        "",
        "## Sync rule",
        "",
        doc["sync_rule"],
