...
PROPERTY_ROUTING: dict[str, tuple[str, float]] = {
    ...
    "semi_major_au": ("Planetary_Science", 0.0003),
    "orbital_eccentricity": ("Planetary_Science", 0.0003),
    "inclination_deg": ("Planetary_Science", 0.0003),
    "mean_motion_deg_day": ("Astronomy", 0.00025),
    "perihelion_au": ("Planetary_Science", 0.0003),
    "aphelion_au": ("Planetary_Science", 0.0003),
    "mpcorb_h_mag": ("Planetary_Science", 0.0003),
    "mpcorb_a_main_belt": ("Planetary_Science", 0.0003),
    "mpcorb_e_main_belt": ("Planetary_Science", 0.0003),
    "mpcorb_i_main_belt": ("Planetary_Science", 0.0003),
    "mpcorb_a_neo": ("Planetary_Science", 0.00025),
    "mpcorb_a_distant": ("Astrophysics", 0.0003),
    "mpcorb_e_distant": ("Astrophysics", 0.0003),
    "mpcorb_a_comet": ("Meteorology", 0.0006),
    "mpcorb_e_comet": ("Meteorology", 0.0006),
    "mpcorb_object_count": ("Astronomy", 0.00025),
    "yin_yang_observer_gap": ("Psychology", 0.0003),
    "consciousness_factor_channel": ("Neuroscience", 0.00035),
    "poof_valve_channel": ("Quantum_Mechanics", 0.00015),
    "dimensional_interface_S": ("Astronomy", 0.00025),
