#!/usr/bin/env python3
"""Generate FSOT/Formal/MaterialsSpeciesBridgePriors.lean."""
...
MANIFEST = ROOT / "data" / "materials_species_bridge_manifest.yaml"
BENCH = ROOT / "data" / "materials_species_bridge_benchmark.json"
OUTPUT = ROOT / "FSOT" / "Formal" / "MaterialsSpeciesBridgePriors.lean"
...
def main() -> int:
    ...
    text = extension_priors_lean(
        module_title="FSOT Formal MaterialsSpeciesBridgePriors — SMILES engineering ↔ species catalog metals.",
        generator="scripts/gen_materials_species_bridge_lean.py",
        prefix="materials_species_bridge",
