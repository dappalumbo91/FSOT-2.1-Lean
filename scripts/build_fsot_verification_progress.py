...
def build_progress() -> dict:
    ...
    return {
        ...
        "current_position": "Tier 77 Post–Tier 76 maintenance — 245/245 extension domains verified, hybrid FI + KB bundle + r_d tightening + coupling refresh + H0/FPC prereg validation",
        "tiers": tiers,
