...
def main() -> int:
    ...
    lean_conn_ok = subprocess.run(
        [
            ...
            "FSOT.Formal.FsotCacheHierarchyPanelPriors",
            "FSOT.Formal.FsotInterconnectCoherencePanelPriors",
            "FSOT.Formal.FsotCPackParityPanelPriors",
            "FSOT.Formal.FsotHardwareDepthSpinePriors",
        ],
        cwd=str(ROOT),
        capture_output=True,
        text=True,
