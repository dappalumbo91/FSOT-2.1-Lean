...
3. Scalar engine — R1–R3, R8: seeds, \(S=K(T_1+T_2+T_3)\), pin D1D38A, APPLY law  
...
11. Falsifiability + one-command repro  
12. Discussion — peer review remaining; T3/T4 uniqueness OPEN_NOT_CLAIMED  
13. Conclusion  

**Do not** put pre-submission admin checklist in the PDF.  
**Do not** put 477 domain travelogue in the PDF — atlas stays GitHub.
