...
theorem quantum_trinary_syntax_bundle :
  ...
  refine ⟨?h1, ?h2, ?h3⟩
  · unfold quantum_trinary_syntax_observable_count; norm_num
  · unfold quantum_trinary_syntax_D_eff; norm_num
