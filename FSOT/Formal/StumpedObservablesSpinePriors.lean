...
theorem stumped_observables_spine_observable_count_pos : 0 < stumped_observables_spine_observable_count := by
  unfold stumped_observables_spine_observable_count; norm_num
...
theorem stumped_observables_spine_bundle :
  ...
  refine ⟨
    by unfold stumped_observables_spine_observable_count; norm_num,
    by unfold stumped_observables_spine_D_eff; norm_num,
