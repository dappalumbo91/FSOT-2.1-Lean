...
theorem longevity_telomere_repair_observable_count_pos : 0 < longevity_telomere_repair_observable_count := by
  unfold longevity_telomere_repair_observable_count; norm_num
...
theorem longevity_telomere_repair_bundle :
  ...
  refine ⟨
    by unfold longevity_telomere_repair_observable_count; norm_num,
    by unfold longevity_telomere_repair_D_eff; norm_num,
