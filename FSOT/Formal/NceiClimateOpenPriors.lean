...
theorem ncei_climate_open_bundle :
  ...
  refine ⟨?h1, ?h2, ?h3⟩
  · unfold ncei_climate_open_observable_count; norm_num
  · unfold ncei_climate_open_D_eff; norm_num
