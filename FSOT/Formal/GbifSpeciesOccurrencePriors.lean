...
def gbif_species_occurrence_observable_count : ℕ := 600
...
theorem gbif_species_occurrence_median_error_under_half_pct :
    gbif_species_occurrence_median_error_pct < (0.5 : ℝ) := by
  unfold gbif_species_occurrence_median_error_pct; norm_num

theorem gbif_species_occurrence_bundle :
    gbif_species_occurrence_observable_count = 600 ∧
    gbif_species_occurrence_D_eff = 15 ∧
    gbif_species_occurrence_median_error_pct < (0.5 : ℝ) ∧
    raw_S (get_domain_params "biological") > 0 := by
  refine ⟨
    by unfold gbif_species_occurrence_observable_count; norm_num,
    by unfold gbif_species_occurrence_D_eff; norm_num,
    gbif_species_occurrence_median_error_under_half_pct,
