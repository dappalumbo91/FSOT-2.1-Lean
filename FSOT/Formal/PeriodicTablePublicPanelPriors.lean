...
def periodic_table_public_panel_D_eff : ℕ := 5
...
theorem periodic_table_public_panel_bundle :
    ...
    periodic_table_public_panel_D_eff = 5 ∧
    (9.5e-05 : ℝ) < (0.5 : ℝ) ∧
    raw_S (get_domain_params "energy") > 0 := by
  refine ⟨
    by unfold periodic_table_public_panel_observable_count; decide,
    by unfold periodic_table_public_panel_D_eff; decide,
