...
theorem codata_full_table_open_bundle :
  ...
  refine ⟨?h1, ?h2, ?h3⟩
  · unfold codata_full_table_open_observable_count; norm_num
  · unfold codata_full_table_open_D_eff; norm_num
