...
theorem nasa_neo_feed_observable_count_pos : 0 < nasa_neo_feed_observable_count := by
  unfold nasa_neo_feed_observable_count; decide

theorem nasa_neo_feed_median_error_under_five_pct :
    nasa_neo_feed_median_error_pct < (5 : ℝ) := by
  unfold nasa_neo_feed_median_error_pct
  exact (by norm_num : (0.021097  : ℝ) < (5 : ℝ))
...
theorem nasa_neo_feed_bundle :
  ...
  refine ⟨
    by unfold nasa_neo_feed_observable_count; decide,
    by unfold nasa_neo_feed_D_eff; decide,
