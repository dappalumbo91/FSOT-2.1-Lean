...
def observer_channel_derivation_observable_count : ℕ := 348
def observer_channel_derivation_D_eff : ℕ := 11
...
theorem observer_channel_derivation_bundle :
    ...
    observer_channel_derivation_D_eff = 11 ∧
    (0.0525102820198906 : ℝ) < (0.5 : ℝ) ∧
    raw_S (get_domain_params "energy") > 0 := by
  refine ⟨
    by unfold observer_channel_derivation_observable_count; decide,
    by unfold observer_channel_derivation_D_eff; decide,
