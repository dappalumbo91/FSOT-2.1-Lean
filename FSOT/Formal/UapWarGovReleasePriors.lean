...
theorem uap_war_gov_release_observable_count_pos : 0 < uap_war_gov_release_observable_count := by
  unfold uap_war_gov_release_observable_count; norm_num
...
theorem uap_war_gov_release_bundle :
  ...
  refine ⟨
    by unfold uap_war_gov_release_observable_count; norm_num,
    by unfold uap_war_gov_release_D_eff; norm_num,
