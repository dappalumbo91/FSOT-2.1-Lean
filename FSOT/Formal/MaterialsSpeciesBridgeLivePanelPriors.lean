...
theorem materials_species_bridge_live_panel_observable_count_pos : 0 < materials_species_bridge_live_panel_observable_count := by
  unfold materials_species_bridge_live_panel_observable_count; norm_num
...
theorem materials_species_bridge_live_panel_bundle :
  ...
  refine ⟨
    by unfold materials_species_bridge_live_panel_observable_count; norm_num,
    by unfold materials_species_bridge_live_panel_D_eff; norm_num,
