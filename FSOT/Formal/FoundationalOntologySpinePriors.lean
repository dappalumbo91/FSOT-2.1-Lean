...
theorem foundational_ontology_spine_observable_count_pos : 0 < foundational_ontology_spine_observable_count := by
  unfold foundational_ontology_spine_observable_count; norm_num
...
theorem foundational_ontology_spine_bundle :
  ...
  refine ⟨
    by unfold foundational_ontology_spine_observable_count; norm_num,
    by unfold foundational_ontology_spine_D_eff; norm_num,
