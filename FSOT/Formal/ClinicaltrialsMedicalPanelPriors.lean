...
theorem clinicaltrials_medical_panel_observable_count_pos : 0 < clinicaltrials_medical_panel_observable_count := by
  unfold clinicaltrials_medical_panel_observable_count; norm_num
...
theorem clinicaltrials_medical_panel_bundle :
  ...
  refine ⟨
    by unfold clinicaltrials_medical_panel_observable_count; norm_num,
    by unfold clinicaltrials_medical_panel_D_eff; norm_num,
