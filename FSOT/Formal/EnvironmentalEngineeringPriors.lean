...
theorem environmental_engineering_observable_count_pos : 0 < environmental_engineering_observable_count := by
  unfold environmental_engineering_observable_count; norm_num
...
theorem environmental_engineering_bundle :
  ...
  refine ⟨
    by unfold environmental_engineering_observable_count; norm_num,
    by unfold environmental_engineering_D_eff; norm_num,
