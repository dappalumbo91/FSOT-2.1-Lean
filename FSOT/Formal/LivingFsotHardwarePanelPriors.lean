...
def living_fsot_hardware_panel_D_eff : ℕ := 8
...
theorem living_fsot_hardware_panel_bundle :
    ...
    living_fsot_hardware_panel_D_eff = 8 ∧
    (0.031506 : ℝ) < (0.5 : ℝ) ∧
    raw_S (get_domain_params "energy") > 0 := by
  refine ⟨
    by unfold living_fsot_hardware_panel_observable_count; decide,
    by unfold living_fsot_hardware_panel_D_eff; decide,
