...
theorem nasa_donki_solar_panel_observable_count_pos : 0 < nasa_donki_solar_panel_observable_count := by
  unfold nasa_donki_solar_panel_observable_count; norm_num
...
theorem nasa_donki_solar_panel_bundle :
  ...
  refine ⟨
    by unfold nasa_donki_solar_panel_observable_count; norm_num,
    by unfold nasa_donki_solar_panel_D_eff; norm_num,
