...
theorem experimental_base_mathematics_panel_observable_count_pos : 0 < experimental_base_mathematics_panel_observable_count := by
  unfold experimental_base_mathematics_panel_observable_count; norm_num
...
theorem experimental_base_mathematics_panel_bundle :
  ...
  refine ⟨
    by unfold experimental_base_mathematics_panel_observable_count; norm_num,
    by unfold experimental_base_mathematics_panel_D_eff; norm_num,
