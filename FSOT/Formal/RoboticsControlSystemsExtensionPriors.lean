...
theorem robotics_control_ext_pooled_median_under_five_pct :
    robotics_control_ext_pooled_median_error_pct < (5 : ℝ) := by
  unfold robotics_control_ext_pooled_median_error_pct; norm_num

theorem robotics_control_ext_headline_median_under_five_pct :
    robotics_control_ext_headline_median_error_pct < (5 : ℝ) := by
...
theorem robotics_control_ext_bundle :
    ...
    robotics_control_ext_pooled_median_error_pct < (5 : ℝ) ∧
    robotics_control_ext_headline_median_error_pct < (5 : ℝ) ∧
    0 < robotics_control_ext_beats_sota_headlines ∧
    raw_S (get_domain_params "consciousness") > 0 := by
  refine ⟨
    by unfold robotics_control_ext_observable_count; norm_num,
    robotics_control_ext_pooled_median_under_five_pct,
    robotics_control_ext_headline_median_under_five_pct,
