...
theorem certified_agent_qwen_bundle :
    ...
    certified_agent_qwen_D_eff = 11 ∧
    certified_agent_qwen_median_error_pct < (5 : ℝ) ∧
    raw_S (get_domain_params "consciousness") > 0 := by
  refine ⟨
    by unfold certified_agent_qwen_observable_count; decide,
    by unfold certified_agent_qwen_D_eff; decide,
    certified_agent_qwen_median_error_under_five_pct,
