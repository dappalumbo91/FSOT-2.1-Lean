...
theorem stsci_mast_telescope_observable_count_pos : 0 < stsci_mast_telescope_observable_count := by
  unfold stsci_mast_telescope_observable_count; norm_num
...
theorem stsci_mast_telescope_bundle :
  ...
  refine ⟨
    by unfold stsci_mast_telescope_observable_count; norm_num,
    by unfold stsci_mast_telescope_D_eff; norm_num,
