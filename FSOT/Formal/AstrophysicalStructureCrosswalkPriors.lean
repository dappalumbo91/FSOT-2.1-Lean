...
theorem astrophysical_structure_crosswalk_observable_count_pos : 0 < astrophysical_structure_crosswalk_observable_count := by
  unfold astrophysical_structure_crosswalk_observable_count; decide
...
theorem astrophysical_structure_crosswalk_bundle :
  ...
  refine ⟨
    by unfold astrophysical_structure_crosswalk_observable_count; decide,
    by unfold astrophysical_structure_crosswalk_D_eff; decide,
