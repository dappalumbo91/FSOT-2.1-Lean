...
theorem canonical_oracle_panel_observable_count_pos : 0 < canonical_oracle_panel_observable_count := by
  unfold canonical_oracle_panel_observable_count; norm_num

theorem canonical_oracle_panel_median_error_under_half_pct :
    (0.013294 : ℝ) < (0.5 : ℝ) := by norm_num
...
theorem canonical_oracle_panel_bundle :
  ...
  refine ⟨
    by unfold canonical_oracle_panel_observable_count; norm_num,
    by unfold canonical_oracle_panel_D_eff; norm_num,
