...
theorem scientific_expansion_depth_spine_observable_count_pos : 0 < scientific_expansion_depth_spine_observable_count := by
  unfold scientific_expansion_depth_spine_observable_count; norm_num
...
theorem scientific_expansion_depth_spine_bundle :
  ...
  refine ⟨
    by unfold scientific_expansion_depth_spine_observable_count; norm_num,
    by unfold scientific_expansion_depth_spine_D_eff; norm_num,
