...
theorem environmental_engineering_ext_pooled_median_under_five_pct :
    environmental_engineering_ext_pooled_median_error_pct < (5 : ℝ) := by
  unfold environmental_engineering_ext_pooled_median_error_pct; norm_num

theorem environmental_engineering_ext_headline_median_under_five_pct :
    environmental_engineering_ext_headline_median_error_pct < (5 : ℝ) := by
...
theorem environmental_engineering_ext_bundle :
    ...
    environmental_engineering_ext_pooled_median_error_pct < (5 : ℝ) ∧
    environmental_engineering_ext_headline_median_error_pct < (5 : ℝ) ∧
  ...
  refine ⟨
    ...
    environmental_engineering_ext_pooled_median_under_five_pct,
    environmental_engineering_ext_headline_median_under_five_pct,
