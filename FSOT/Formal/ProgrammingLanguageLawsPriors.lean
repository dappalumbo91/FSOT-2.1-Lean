...
theorem programming_language_laws_observable_count_pos : 0 < programming_language_laws_observable_count := by
  unfold programming_language_laws_observable_count; norm_num
...
theorem programming_language_laws_bundle :
  ...
  refine ⟨
    by unfold programming_language_laws_observable_count; norm_num,
    by unfold programming_language_laws_D_eff; norm_num,
