...
def pl_laws_observable_count : ℕ := 21
def pl_laws_pooled_median_error_pct : ℝ := (0.007383655181691928 : ℝ)
def pl_laws_headline_median_error_pct : ℝ := (0.007383655181691928 : ℝ)
def pl_laws_beats_sota_headlines : ℕ := 2
def pl_laws_D_eff : ℕ := 15

def pl_laws_law_count : ℕ := 15
