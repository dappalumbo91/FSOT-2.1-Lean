...
theorem inertial_confinement_fusion_panel_bundle :
    ...
    inertial_confinement_fusion_panel_D_eff = 12 ∧
    (7.9e-05 : ℝ) < (0.5 : ℝ) ∧
    raw_S (get_domain_params "energy") > 0 := by
  refine ⟨
    by unfold inertial_confinement_fusion_panel_observable_count; decide,
    by unfold inertial_confinement_fusion_panel_D_eff; decide,
