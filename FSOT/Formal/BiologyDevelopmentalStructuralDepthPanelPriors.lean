...
theorem biology_developmental_structural_depth_panel_observable_count_pos : 0 < biology_developmental_structural_depth_panel_observable_count := by
  unfold biology_developmental_structural_depth_panel_observable_count; norm_num
...
theorem biology_developmental_structural_depth_panel_bundle :
  ...
  refine ⟨
    by unfold biology_developmental_structural_depth_panel_observable_count; norm_num,
    by unfold biology_developmental_structural_depth_panel_D_eff; norm_num,
