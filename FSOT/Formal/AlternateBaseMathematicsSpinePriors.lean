...
theorem alternate_base_mathematics_spine_observable_count_pos : 0 < alternate_base_mathematics_spine_observable_count := by
  unfold alternate_base_mathematics_spine_observable_count; norm_num
...
theorem alternate_base_mathematics_spine_bundle :
  ...
  refine ⟨
    by unfold alternate_base_mathematics_spine_observable_count; norm_num,
    by unfold alternate_base_mathematics_spine_D_eff; norm_num,
