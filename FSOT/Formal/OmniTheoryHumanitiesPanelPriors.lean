...
theorem omni_theory_humanities_panel_observable_count_pos : 0 < omni_theory_humanities_panel_observable_count := by
  unfold omni_theory_humanities_panel_observable_count; norm_num
...
theorem omni_theory_humanities_panel_bundle :
  ...
  refine ⟨
    by unfold omni_theory_humanities_panel_observable_count; norm_num,
    by unfold omni_theory_humanities_panel_D_eff; norm_num,
