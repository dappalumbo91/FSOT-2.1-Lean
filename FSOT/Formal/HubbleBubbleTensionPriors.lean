...
theorem hubble_bubble_tension_observable_count_pos : 0 < hubble_bubble_tension_observable_count := by
  unfold hubble_bubble_tension_observable_count; norm_num
...
theorem hubble_bubble_tension_bundle :
  ...
  refine ⟨
    by unfold hubble_bubble_tension_observable_count; norm_num,
    by unfold hubble_bubble_tension_D_eff; norm_num,
