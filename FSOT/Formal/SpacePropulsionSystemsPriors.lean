...
theorem space_propulsion_systems_median_error_under_half_pct :
    space_propulsion_systems_median_error_pct < (0.5 : ℝ) := by
...
theorem space_propulsion_systems_bundle :
    ...
    space_propulsion_systems_median_error_pct < (0.5 : ℝ) ∧
  ...
  refine ⟨
    ...
    space_propulsion_systems_median_error_under_half_pct,
