...
theorem fluid_phase_current_spine_observable_count_pos : 0 < fluid_phase_current_spine_observable_count := by
  unfold fluid_phase_current_spine_observable_count; norm_num
...
theorem fluid_phase_current_spine_bundle :
  ...
  refine ⟨
    by unfold fluid_phase_current_spine_observable_count; norm_num,
    by unfold fluid_phase_current_spine_D_eff; norm_num,
