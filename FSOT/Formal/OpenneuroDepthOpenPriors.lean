...
theorem openneuro_depth_open_bundle :
  ...
  refine ⟨?h1, ?h2, ?h3⟩
  · unfold openneuro_depth_open_observable_count; norm_num
  · unfold openneuro_depth_open_D_eff; norm_num
