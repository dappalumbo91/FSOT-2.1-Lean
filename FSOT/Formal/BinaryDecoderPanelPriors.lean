...
theorem binary_decoder_panel_observable_count_pos : 0 < binary_decoder_panel_observable_count := by
  unfold binary_decoder_panel_observable_count; norm_num
...
theorem binary_decoder_panel_bundle :
  ...
  refine ⟨
    by unfold binary_decoder_panel_observable_count; norm_num,
    by unfold binary_decoder_panel_D_eff; norm_num,
