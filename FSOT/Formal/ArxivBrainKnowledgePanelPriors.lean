...
theorem arxiv_brain_knowledge_panel_observable_count_pos : 0 < arxiv_brain_knowledge_panel_observable_count := by
  unfold arxiv_brain_knowledge_panel_observable_count; norm_num
...
theorem arxiv_brain_knowledge_panel_bundle :
  ...
  refine ⟨
    by unfold arxiv_brain_knowledge_panel_observable_count; norm_num,
    by unfold arxiv_brain_knowledge_panel_D_eff; norm_num,
