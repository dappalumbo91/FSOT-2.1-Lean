...
def neutrino_physics_panel_D_eff : ℕ := 5
...
theorem neutrino_physics_panel_bundle :
    ...
    neutrino_physics_panel_D_eff = 5 ∧
    (0.009504 : ℝ) < (0.5 : ℝ) ∧
    raw_S (get_domain_params "energy") > 0 := by
  refine ⟨
    by unfold neutrino_physics_panel_observable_count; decide,
    by unfold neutrino_physics_panel_D_eff; decide,
