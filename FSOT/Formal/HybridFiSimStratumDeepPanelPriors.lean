...
theorem hybrid_fi_sim_stratum_deep_panel_observable_count_pos : 0 < hybrid_fi_sim_stratum_deep_panel_observable_count := by
  unfold hybrid_fi_sim_stratum_deep_panel_observable_count; norm_num
...
theorem hybrid_fi_sim_stratum_deep_panel_bundle :
  ...
  refine ⟨
    by unfold hybrid_fi_sim_stratum_deep_panel_observable_count; norm_num,
    by unfold hybrid_fi_sim_stratum_deep_panel_D_eff; norm_num,
