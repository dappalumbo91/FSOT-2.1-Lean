...
theorem nasa_exoplanet_archive_observable_count_pos : 0 < nasa_exoplanet_archive_observable_count := by
  unfold nasa_exoplanet_archive_observable_count; norm_num

theorem nasa_exoplanet_archive_median_error_under_half_pct :
    nasa_exoplanet_archive_median_error_pct < (0.5 : ℝ) := by
...
theorem nasa_exoplanet_archive_bundle :
    ...
    nasa_exoplanet_archive_median_error_pct < (0.5 : ℝ) ∧
    raw_S (get_domain_params "astronomical") > 0 := by
  refine ⟨
    by unfold nasa_exoplanet_archive_observable_count; norm_num,
    by unfold nasa_exoplanet_archive_D_eff; norm_num,
    nasa_exoplanet_archive_median_error_under_half_pct,
