...
theorem trinary_hardware_motif_observable_count_pos : 0 < trinary_hardware_motif_observable_count := by
  unfold trinary_hardware_motif_observable_count; norm_num

theorem trinary_hardware_motif_median_error_under_half_pct :
    trinary_hardware_motif_median_error_pct < (0.5 : ℝ) := by
...
theorem trinary_hardware_motif_bundle :
    ...
    trinary_hardware_motif_median_error_pct < (0.5 : ℝ) ∧
    raw_S (get_domain_params "consciousness") > 0 := by
  refine ⟨
    by unfold trinary_hardware_motif_observable_count; norm_num,
    by unfold trinary_hardware_motif_D_eff; norm_num,
    trinary_hardware_motif_median_error_under_half_pct,
