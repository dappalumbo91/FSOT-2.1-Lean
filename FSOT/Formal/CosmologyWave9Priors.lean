...
theorem cosmology_wave9_observable_count_pos : 0 < cosmology_wave9_observable_count := by
  unfold cosmology_wave9_observable_count; norm_num

theorem cosmology_wave9_max_error_under_five_pct :
    cosmology_wave9_max_error_pct < (5 : ℝ) := by
  unfold cosmology_wave9_max_error_pct; norm_num

theorem cosmology_wave9_median_error_under_five_pct :
    cosmology_wave9_median_error_pct < (5 : ℝ) := by
  unfold cosmology_wave9_median_error_pct; norm_num

/-- Bundle: wave9 observables within 5% tolerance band. -/
theorem cosmology_wave9_bundle :
    cosmology_wave9_observable_count = 7 ∧
    cosmology_wave9_max_error_pct < (5 : ℝ) ∧
    cosmology_wave9_median_error_pct < (5 : ℝ) ∧
    (0 : ℝ) < omega_b_h2_fsot S_cosm_cached S_quant_cached := by
  refine ⟨
    by unfold cosmology_wave9_observable_count; norm_num,
    cosmology_wave9_max_error_under_five_pct,
    cosmology_wave9_median_error_under_five_pct,
