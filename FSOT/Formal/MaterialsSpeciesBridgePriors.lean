...
theorem materials_species_bridge_median_error_under_half_pct :
    materials_species_bridge_median_error_pct < (0.5 : ℝ) := by
...
theorem materials_species_bridge_bundle :
    ...
    materials_species_bridge_median_error_pct < (0.5 : ℝ) ∧
  ...
  refine ⟨
    ...
    materials_species_bridge_median_error_under_half_pct,
