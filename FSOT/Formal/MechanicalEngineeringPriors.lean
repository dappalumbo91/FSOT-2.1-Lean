...
theorem mechanical_engineering_observable_count_pos : 0 < mechanical_engineering_observable_count := by
  unfold mechanical_engineering_observable_count; norm_num
...
theorem mechanical_engineering_bundle :
  ...
  refine ⟨
    by unfold mechanical_engineering_observable_count; norm_num,
    by unfold mechanical_engineering_D_eff; norm_num,
