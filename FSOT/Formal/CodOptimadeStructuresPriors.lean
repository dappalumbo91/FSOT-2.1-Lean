...
theorem cod_optimade_structures_bundle :
  ...
  refine ⟨?h1, ?h2, ?h3⟩
  · unfold cod_optimade_structures_observable_count; norm_num
  · unfold cod_optimade_structures_D_eff; norm_num
