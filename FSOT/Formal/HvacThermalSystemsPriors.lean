...
theorem hvac_thermal_systems_observable_count_pos : 0 < hvac_thermal_systems_observable_count := by
  unfold hvac_thermal_systems_observable_count; norm_num

theorem hvac_thermal_systems_median_error_under_half_pct :
    hvac_thermal_systems_median_error_pct < (0.5 : ℝ) := by
...
theorem hvac_thermal_systems_bundle :
    ...
    hvac_thermal_systems_median_error_pct < (0.5 : ℝ) ∧
    raw_S (get_domain_params "energy") > 0 := by
  refine ⟨
    by unfold hvac_thermal_systems_observable_count; norm_num,
    by unfold hvac_thermal_systems_D_eff; norm_num,
    hvac_thermal_systems_median_error_under_half_pct,
