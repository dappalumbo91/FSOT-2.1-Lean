...
theorem zero_boundary_not_entity_panel_observable_count_pos : 0 < zero_boundary_not_entity_panel_observable_count := by
  unfold zero_boundary_not_entity_panel_observable_count; norm_num
...
theorem zero_boundary_not_entity_panel_bundle :
  ...
  refine ⟨
    by unfold zero_boundary_not_entity_panel_observable_count; norm_num,
    by unfold zero_boundary_not_entity_panel_D_eff; norm_num,
