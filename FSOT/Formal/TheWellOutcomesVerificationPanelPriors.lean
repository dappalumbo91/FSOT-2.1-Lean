...
def the_well_outcomes_verification_panel_observable_count : ℕ := 381
...
theorem the_well_outcomes_verification_panel_observable_count_pos : 0 < the_well_outcomes_verification_panel_observable_count := by
  unfold the_well_outcomes_verification_panel_observable_count; norm_num
...
theorem the_well_outcomes_verification_panel_bundle :
    the_well_outcomes_verification_panel_observable_count = 381 ∧
    the_well_outcomes_verification_panel_D_eff = 20 ∧
    (0.031159 : ℝ) < (0.5 : ℝ) ∧
    raw_S (get_domain_params "energy") > 0 := by
  refine ⟨
    by unfold the_well_outcomes_verification_panel_observable_count; norm_num,
    by unfold the_well_outcomes_verification_panel_D_eff; norm_num,
