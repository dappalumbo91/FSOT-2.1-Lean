...
theorem cosmology_wave8_observable_count_pos : 0 < cosmology_wave8_observable_count := by
  unfold cosmology_wave8_observable_count; decide

theorem cosmology_wave8_max_error_under_half_pct :
    cosmology_wave8_max_error_pct < (0.5 : ℝ) := by
  unfold cosmology_wave8_max_error_pct
  exact (by norm_num : (0.35683948712437213  : ℝ) < 0.5)

theorem cosmology_wave8_median_error_under_half_pct :
    cosmology_wave8_median_error_pct < (0.5 : ℝ) := by
  unfold cosmology_wave8_median_error_pct
  exact (by norm_num : (0.014145689288404753  : ℝ) < 0.5)

/-- Bundle: wave8 observables within 5% tolerance band. -/
theorem cosmology_wave8_bundle :
    cosmology_wave8_observable_count = 52 ∧
    cosmology_wave8_max_error_pct < (0.5 : ℝ) ∧
    cosmology_wave8_median_error_pct < (0.5 : ℝ) ∧
    (0 : ℝ) < omega_b_h2_fsot S_cosm_cached S_quant_cached := by
  refine ⟨
    by unfold cosmology_wave8_observable_count; decide,
    cosmology_wave8_max_error_under_half_pct,
    cosmology_wave8_median_error_under_half_pct,
