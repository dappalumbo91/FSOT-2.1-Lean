...
theorem gwtc_catalog_open_bundle :
  ...
  refine ⟨?h1, ?h2, ?h3⟩
  · unfold gwtc_catalog_open_observable_count; norm_num
  · unfold gwtc_catalog_open_D_eff; norm_num
