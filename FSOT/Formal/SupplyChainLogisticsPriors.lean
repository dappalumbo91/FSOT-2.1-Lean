...
theorem supply_chain_logistics_observable_count_pos : 0 < supply_chain_logistics_observable_count := by
  unfold supply_chain_logistics_observable_count; norm_num
...
theorem supply_chain_logistics_bundle :
  ...
  refine ⟨
    by unfold supply_chain_logistics_observable_count; norm_num,
    by unfold supply_chain_logistics_D_eff; norm_num,
