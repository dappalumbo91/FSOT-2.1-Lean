...
theorem jarvis_dft_open_panel_bundle :
  ...
  refine ⟨?h1, ?h2, ?h3⟩
  · unfold jarvis_dft_open_panel_observable_count; norm_num
  · unfold jarvis_dft_open_panel_D_eff; norm_num
