...
theorem sports_biomechanics_gap_fill_pooled_median_under_five_pct :
    sports_biomechanics_gap_fill_pooled_median_error_pct < (5 : ℝ) := by
  unfold sports_biomechanics_gap_fill_pooled_median_error_pct; norm_num

theorem sports_biomechanics_gap_fill_headline_median_under_five_pct :
    sports_biomechanics_gap_fill_headline_median_error_pct < (5 : ℝ) := by
...
theorem sports_biomechanics_gap_fill_bundle :
    ...
    sports_biomechanics_gap_fill_pooled_median_error_pct < (5 : ℝ) ∧
    sports_biomechanics_gap_fill_headline_median_error_pct < (5 : ℝ) ∧
  ...
  refine ⟨
    ...
    sports_biomechanics_gap_fill_pooled_median_under_five_pct,
    sports_biomechanics_gap_fill_headline_median_under_five_pct,
