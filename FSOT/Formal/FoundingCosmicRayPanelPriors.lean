...
theorem founding_cosmic_ray_panel_bundle :
    ...
    founding_cosmic_ray_panel_D_eff = 18 ∧
    (0.021221 : ℝ) < (0.5 : ℝ) ∧
    raw_S (get_domain_params "energy") > 0 := by
  refine ⟨
    by unfold founding_cosmic_ray_panel_observable_count; decide,
    by unfold founding_cosmic_ray_panel_D_eff; decide,
