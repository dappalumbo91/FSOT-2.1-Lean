...
theorem preregistered_predictions_observable_count_pos : 0 < preregistered_predictions_observable_count := by
  unfold preregistered_predictions_observable_count; norm_num
...
theorem preregistered_predictions_bundle :
  ...
  refine ⟨
    by unfold preregistered_predictions_observable_count; norm_num,
    by unfold preregistered_predictions_D_eff; norm_num,
