...
theorem endf_iaea_nuclear_open_pooled_median_under_half_pct :
  ...
  unfold endf_iaea_nuclear_open_pooled_median_error_pct
  exact (by norm_num : (0.092131  : ℝ) < 0.5)

theorem endf_iaea_nuclear_open_headline_median_under_half_pct :
    endf_iaea_nuclear_open_headline_median_error_pct < (0.5 : ℝ) := by
  unfold endf_iaea_nuclear_open_headline_median_error_pct
  exact (by norm_num : (0.092131  : ℝ) < 0.5)
...
theorem endf_iaea_nuclear_open_bundle :
  ...
  refine ⟨?h1, ?h2, ?h3⟩
  · unfold endf_iaea_nuclear_open_observable_count; decide
  · unfold endf_iaea_nuclear_open_D_eff; decide
