...
theorem cern_open_data_lhc_median_error_under_half_pct :
    cern_open_data_lhc_median_error_pct < (0.5 : ℝ) := by
...
theorem cern_open_data_lhc_bundle :
    ...
    cern_open_data_lhc_median_error_pct < (0.5 : ℝ) ∧
  ...
  refine ⟨
    ...
    cern_open_data_lhc_median_error_under_half_pct,
