...
theorem supply_chain_logistics_panel_observable_count_pos : 0 < supply_chain_logistics_panel_observable_count := by
  unfold supply_chain_logistics_panel_observable_count; norm_num
...
theorem supply_chain_logistics_panel_bundle :
  ...
  refine ⟨
    by unfold supply_chain_logistics_panel_observable_count; norm_num,
    by unfold supply_chain_logistics_panel_D_eff; norm_num,
