...
theorem consciousness_soul_bridge_bundle :
    ...
    consciousness_soul_bridge_D_eff = 10 ∧
    (0.0 : ℝ) < (0.5 : ℝ) ∧
    raw_S (get_domain_params "energy") > 0 := by
  refine ⟨
    by unfold consciousness_soul_bridge_observable_count; decide,
    by unfold consciousness_soul_bridge_D_eff; decide,
