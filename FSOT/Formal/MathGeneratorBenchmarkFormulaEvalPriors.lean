...
def math_generator_benchmark_formula_eval_observable_count : ℕ := 9
...
theorem math_generator_benchmark_formula_eval_median_error_under_half_pct :
    math_generator_benchmark_formula_eval_median_error_pct < (0.5 : ℝ) := by
...
theorem math_generator_benchmark_formula_eval_bundle :
    math_generator_benchmark_formula_eval_observable_count = 9 ∧
    math_generator_benchmark_formula_eval_D_eff = 17 ∧
    math_generator_benchmark_formula_eval_median_error_pct < (0.5 : ℝ) ∧
  ...
  refine ⟨
    ...
    math_generator_benchmark_formula_eval_median_error_under_half_pct,
