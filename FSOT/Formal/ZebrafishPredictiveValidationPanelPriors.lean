...
theorem zebrafish_predictive_validation_observable_count_pos : 0 < zebrafish_predictive_validation_observable_count := by
  unfold zebrafish_predictive_validation_observable_count; norm_num
...
theorem zebrafish_predictive_validation_bundle :
  ...
  refine ⟨
    by unfold zebrafish_predictive_validation_observable_count; norm_num,
    by unfold zebrafish_predictive_validation_D_eff; norm_num,
