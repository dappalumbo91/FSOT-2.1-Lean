...
def stumped_observables_panel_D_eff : ℕ := 25
...
theorem stumped_observables_panel_bundle :
    ...
    stumped_observables_panel_D_eff = 25 ∧
    (0.029748999999999998 : ℝ) < (0.5 : ℝ) ∧
    raw_S (get_domain_params "energy") > 0 := by
  refine ⟨
    by unfold stumped_observables_panel_observable_count; decide,
    by unfold stumped_observables_panel_D_eff; decide,
