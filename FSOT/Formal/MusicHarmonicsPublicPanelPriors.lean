...
theorem music_harmonics_public_panel_bundle :
    ...
    music_harmonics_public_panel_D_eff = 11 ∧
    (0.0 : ℝ) < (0.5 : ℝ) ∧
    raw_S (get_domain_params "energy") > 0 := by
  refine ⟨
    by unfold music_harmonics_public_panel_observable_count; decide,
    by unfold music_harmonics_public_panel_D_eff; decide,
