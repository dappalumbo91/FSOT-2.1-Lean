...
def petrology_geochemistry_panel_D_eff : ℕ := 6
...
theorem petrology_geochemistry_panel_bundle :
    ...
    petrology_geochemistry_panel_D_eff = 6 ∧
    (0.030428 : ℝ) < (0.5 : ℝ) ∧
    raw_S (get_domain_params "energy") > 0 := by
  refine ⟨
    by unfold petrology_geochemistry_panel_observable_count; decide,
    by unfold petrology_geochemistry_panel_D_eff; decide,
