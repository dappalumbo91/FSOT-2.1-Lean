...
theorem trinary_os_tier_e_pooled_median_under_five_pct :
    trinary_os_tier_e_pooled_median_error_pct < (5 : ℝ) := by
  unfold trinary_os_tier_e_pooled_median_error_pct; norm_num

theorem trinary_os_tier_e_headline_median_under_five_pct :
    trinary_os_tier_e_headline_median_error_pct < (5 : ℝ) := by
...
theorem trinary_os_tier_e_bundle :
    ...
    trinary_os_tier_e_pooled_median_error_pct < (5 : ℝ) ∧
    trinary_os_tier_e_headline_median_error_pct < (5 : ℝ) ∧
    0 < trinary_os_tier_e_beats_sota_headlines ∧
    raw_S (get_domain_params "consciousness") > 0 := by
  refine ⟨
    by unfold trinary_os_tier_e_observable_count; norm_num,
    trinary_os_tier_e_pooled_median_under_five_pct,
    trinary_os_tier_e_headline_median_under_five_pct,
