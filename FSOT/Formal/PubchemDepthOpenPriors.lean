...
theorem pubchem_depth_open_bundle :
  ...
  refine ⟨?h1, ?h2, ?h3⟩
  · unfold pubchem_depth_open_observable_count; norm_num
  · unfold pubchem_depth_open_D_eff; norm_num
