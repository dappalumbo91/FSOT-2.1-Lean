...
theorem speleology_ext_observable_count_pos : 0 < speleology_ext_observable_count := by
  unfold speleology_ext_observable_count; norm_num

theorem speleology_ext_pooled_median_under_five_pct :
    speleology_ext_pooled_median_error_pct < (5 : ℝ) := by
  unfold speleology_ext_pooled_median_error_pct; norm_num

theorem speleology_ext_headline_median_under_five_pct :
    speleology_ext_headline_median_error_pct < (5 : ℝ) := by
  unfold speleology_ext_headline_median_error_pct; norm_num
...
theorem speleology_ext_bundle :
  ...
  refine ⟨
    by unfold speleology_ext_observable_count; norm_num,
    speleology_ext_pooled_median_under_five_pct,
    speleology_ext_headline_median_under_five_pct,
