...
theorem fsot_aggregate_organized_panel_bundle :
    ...
    fsot_aggregate_organized_panel_D_eff = 10 ∧
    (0.0 : ℝ) < (0.5 : ℝ) ∧
    raw_S (get_domain_params "energy") > 0 := by
  refine ⟨
    by unfold fsot_aggregate_organized_panel_observable_count; decide,
    by unfold fsot_aggregate_organized_panel_D_eff; decide,
