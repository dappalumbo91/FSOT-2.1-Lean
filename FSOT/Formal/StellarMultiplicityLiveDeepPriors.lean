...
def stellar_multiplicity_live_deep_D_eff : ℕ := 18
...
theorem stellar_multiplicity_live_deep_bundle :
    ...
    stellar_multiplicity_live_deep_D_eff = 18 ∧
    (0.0 : ℝ) < (0.5 : ℝ) ∧
    raw_S (get_domain_params "energy") > 0 := by
  refine ⟨
    by unfold stellar_multiplicity_live_deep_observable_count; decide,
    by unfold stellar_multiplicity_live_deep_D_eff; decide,
