...
theorem chemical_engineering_ext_pooled_median_under_five_pct :
    chemical_engineering_ext_pooled_median_error_pct < (5 : ℝ) := by
  unfold chemical_engineering_ext_pooled_median_error_pct; norm_num

theorem chemical_engineering_ext_headline_median_under_five_pct :
    chemical_engineering_ext_headline_median_error_pct < (5 : ℝ) := by
...
theorem chemical_engineering_ext_bundle :
    ...
    chemical_engineering_ext_pooled_median_error_pct < (5 : ℝ) ∧
    chemical_engineering_ext_headline_median_error_pct < (5 : ℝ) ∧
  ...
  refine ⟨
    ...
    chemical_engineering_ext_pooled_median_under_five_pct,
    chemical_engineering_ext_headline_median_under_five_pct,
