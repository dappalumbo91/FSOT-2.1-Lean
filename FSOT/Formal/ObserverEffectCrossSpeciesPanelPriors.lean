...
def observer_effect_cross_species_panel_D_eff : ℕ := 11
...
theorem observer_effect_cross_species_panel_bundle :
    ...
    observer_effect_cross_species_panel_D_eff = 11 ∧
    (0.0 : ℝ) < (0.5 : ℝ) ∧
    raw_S (get_domain_params "energy") > 0 := by
  refine ⟨
    by unfold observer_effect_cross_species_panel_observable_count; decide,
    by unfold observer_effect_cross_species_panel_D_eff; decide,
