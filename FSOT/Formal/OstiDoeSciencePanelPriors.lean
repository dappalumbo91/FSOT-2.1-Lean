...
theorem osti_doe_science_panel_observable_count_pos : 0 < osti_doe_science_panel_observable_count := by
  unfold osti_doe_science_panel_observable_count; norm_num
...
theorem osti_doe_science_panel_bundle :
  ...
  refine ⟨
    by unfold osti_doe_science_panel_observable_count; norm_num,
    by unfold osti_doe_science_panel_D_eff; norm_num,
