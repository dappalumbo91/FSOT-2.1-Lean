...
theorem open_meteo_live_panel_observable_count_pos : 0 < open_meteo_live_panel_observable_count := by
  unfold open_meteo_live_panel_observable_count; norm_num
...
theorem open_meteo_live_panel_bundle :
  ...
  refine ⟨
    by unfold open_meteo_live_panel_observable_count; norm_num,
    by unfold open_meteo_live_panel_D_eff; norm_num,
