...
theorem botany_observable_count_pos : 0 < botany_observable_count := by
  unfold botany_observable_count; norm_num

theorem botany_median_error_under_half_pct :
    (0.022236250385193387 : ℝ) < (0.5 : ℝ) := by norm_num
...
theorem botany_bundle :
  ...
  refine ⟨
    by unfold botany_observable_count; norm_num,
    by unfold botany_D_eff; norm_num,
