...
theorem ionospheric_chemistry_coupling_observable_count_pos : 0 < ionospheric_chemistry_coupling_observable_count := by
  unfold ionospheric_chemistry_coupling_observable_count; norm_num
...
theorem ionospheric_chemistry_coupling_bundle :
  ...
  refine ⟨
    by unfold ionospheric_chemistry_coupling_observable_count; norm_num,
    by unfold ionospheric_chemistry_coupling_D_eff; norm_num,
