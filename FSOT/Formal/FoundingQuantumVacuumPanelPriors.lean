...
theorem founding_quantum_vacuum_panel_bundle :
    ...
    founding_quantum_vacuum_panel_D_eff = 5 ∧
    (0.01529034996934153 : ℝ) < (0.5 : ℝ) ∧
    raw_S (get_domain_params "energy") > 0 := by
  refine ⟨
    by unfold founding_quantum_vacuum_panel_observable_count; decide,
    by unfold founding_quantum_vacuum_panel_D_eff; decide,
