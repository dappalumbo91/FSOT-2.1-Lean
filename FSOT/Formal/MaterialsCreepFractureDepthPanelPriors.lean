...
def materials_creep_fracture_depth_panel_D_eff : ℕ := 12
...
theorem materials_creep_fracture_depth_panel_bundle :
    ...
    materials_creep_fracture_depth_panel_D_eff = 12 ∧
    (0.011734 : ℝ) < (0.5 : ℝ) ∧
    raw_S (get_domain_params "energy") > 0 := by
  refine ⟨
    by unfold materials_creep_fracture_depth_panel_observable_count; decide,
    by unfold materials_creep_fracture_depth_panel_D_eff; decide,
