...
theorem optics_interferometry_depth_panel_observable_count_pos : 0 < optics_interferometry_depth_panel_observable_count := by
  unfold optics_interferometry_depth_panel_observable_count; norm_num
...
theorem optics_interferometry_depth_panel_bundle :
  ...
  refine ⟨
    by unfold optics_interferometry_depth_panel_observable_count; norm_num,
    by unfold optics_interferometry_depth_panel_D_eff; norm_num,
