...
theorem warp_bh_wh_portal_panel_observable_count_pos : 0 < warp_bh_wh_portal_panel_observable_count := by
  unfold warp_bh_wh_portal_panel_observable_count; norm_num
...
theorem warp_bh_wh_portal_panel_bundle :
  ...
  refine ⟨
    by unfold warp_bh_wh_portal_panel_observable_count; norm_num,
    by unfold warp_bh_wh_portal_panel_D_eff; norm_num,
