...
def world_bank_development_observable_count : ℕ := 165
...
theorem world_bank_development_median_error_under_half_pct :
    world_bank_development_median_error_pct < (0.5 : ℝ) := by
  unfold world_bank_development_median_error_pct; norm_num

theorem world_bank_development_bundle :
    world_bank_development_observable_count = 165 ∧
    world_bank_development_D_eff = 20 ∧
    world_bank_development_median_error_pct < (0.5 : ℝ) ∧
    raw_S (get_domain_params "consciousness") > 0 := by
  refine ⟨
    by unfold world_bank_development_observable_count; norm_num,
    by unfold world_bank_development_D_eff; norm_num,
    world_bank_development_median_error_under_half_pct,
