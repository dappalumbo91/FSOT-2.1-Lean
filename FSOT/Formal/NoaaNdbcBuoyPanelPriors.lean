...
theorem noaa_ndbc_buoy_panel_observable_count_pos : 0 < noaa_ndbc_buoy_panel_observable_count := by
  unfold noaa_ndbc_buoy_panel_observable_count; norm_num
...
theorem noaa_ndbc_buoy_panel_bundle :
  ...
  refine ⟨
    by unfold noaa_ndbc_buoy_panel_observable_count; norm_num,
    by unfold noaa_ndbc_buoy_panel_D_eff; norm_num,
