...
def consciousness_species_multi_panel_D_eff : ℕ := 11
...
theorem consciousness_species_multi_panel_bundle :
    ...
    consciousness_species_multi_panel_D_eff = 11 ∧
    (0.0201195 : ℝ) < (0.5 : ℝ) ∧
    raw_S (get_domain_params "energy") > 0 := by
  refine ⟨
    by unfold consciousness_species_multi_panel_observable_count; decide,
    by unfold consciousness_species_multi_panel_D_eff; decide,
