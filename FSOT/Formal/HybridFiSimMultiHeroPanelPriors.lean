/-
  FSOT Formal HybridFiSimMultiHeroPanelPriors — extension domain Hybrid_FI_Sim_Multi_Hero_Panel.
...
theorem hybrid_fi_sim_multi_hero_panel_bundle :
  ...
  refine ⟨
    by unfold hybrid_fi_sim_multi_hero_panel_observable_count; norm_num,
    by unfold hybrid_fi_sim_multi_hero_panel_D_eff; norm_num,
    hybrid_fi_sim_multi_hero_panel_median_error_under_half_pct,
