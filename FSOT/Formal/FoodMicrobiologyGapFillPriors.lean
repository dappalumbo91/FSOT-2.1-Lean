...
theorem food_microbiology_gap_fill_observable_count_pos : 0 < food_microbiology_gap_fill_observable_count := by
  unfold food_microbiology_gap_fill_observable_count; norm_num

theorem food_microbiology_gap_fill_pooled_median_under_five_pct :
    food_microbiology_gap_fill_pooled_median_error_pct < (5 : ℝ) := by
  unfold food_microbiology_gap_fill_pooled_median_error_pct; norm_num

theorem food_microbiology_gap_fill_headline_median_under_five_pct :
    food_microbiology_gap_fill_headline_median_error_pct < (5 : ℝ) := by
  unfold food_microbiology_gap_fill_headline_median_error_pct; norm_num

theorem food_microbiology_gap_fill_beats_sota_headlines_pos : 0 < food_microbiology_gap_fill_beats_sota_headlines := by
  unfold food_microbiology_gap_fill_beats_sota_headlines; norm_num

theorem food_microbiology_gap_fill_bundle :
    food_microbiology_gap_fill_observable_count = 30 ∧
    food_microbiology_gap_fill_pooled_median_error_pct < (5 : ℝ) ∧
    food_microbiology_gap_fill_headline_median_error_pct < (5 : ℝ) ∧
    0 < food_microbiology_gap_fill_beats_sota_headlines ∧
    raw_S (get_domain_params "biological") > 0 := by
  refine ⟨
    by unfold food_microbiology_gap_fill_observable_count; norm_num,
    food_microbiology_gap_fill_pooled_median_under_five_pct,
    food_microbiology_gap_fill_headline_median_under_five_pct,
