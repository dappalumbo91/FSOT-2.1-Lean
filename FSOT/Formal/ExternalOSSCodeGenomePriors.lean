...
def external_oss_observable_count : ℕ := 87
...
def external_oss_oss_sample_count : ℕ := 15
def external_oss_high_affinity_pair_count : ℕ := 29
...
theorem external_oss_bundle :
    external_oss_observable_count = 87 ∧
