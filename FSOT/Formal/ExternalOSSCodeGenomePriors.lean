...
theorem external_oss_code_genome_observable_count_pos : 0 < external_oss_code_genome_observable_count := by
  unfold external_oss_code_genome_observable_count; norm_num
...
theorem external_oss_code_genome_bundle :
  ...
  refine ⟨
    by unfold external_oss_code_genome_observable_count; norm_num,
    by unfold external_oss_code_genome_D_eff; norm_num,
