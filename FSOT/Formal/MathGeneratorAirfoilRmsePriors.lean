...
theorem math_generator_airfoil_rmse_median_error_under_half_pct :
    math_generator_airfoil_rmse_median_error_pct < (0.5 : ℝ) := by
...
theorem math_generator_airfoil_rmse_bundle :
    ...
    math_generator_airfoil_rmse_median_error_pct < (0.5 : ℝ) ∧
  ...
  refine ⟨
    ...
    math_generator_airfoil_rmse_median_error_under_half_pct,
