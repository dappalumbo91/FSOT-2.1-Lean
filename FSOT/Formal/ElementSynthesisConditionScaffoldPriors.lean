...
def element_synthesis_condition_scaffold_D_eff : ℕ := 12
...
theorem element_synthesis_condition_scaffold_bundle :
    ...
    element_synthesis_condition_scaffold_D_eff = 12 ∧
    (0.000787 : ℝ) < (0.5 : ℝ) ∧
    raw_S (get_domain_params "energy") > 0 := by
  refine ⟨
    by unfold element_synthesis_condition_scaffold_observable_count; decide,
    by unfold element_synthesis_condition_scaffold_D_eff; decide,
