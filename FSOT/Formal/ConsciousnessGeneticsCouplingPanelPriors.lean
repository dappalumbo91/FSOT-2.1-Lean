...
def consciousness_genetics_coupling_panel_D_eff : ℕ := 9
...
theorem consciousness_genetics_coupling_panel_bundle :
    ...
    consciousness_genetics_coupling_panel_D_eff = 9 ∧
    (0.031506 : ℝ) < (0.5 : ℝ) ∧
    raw_S (get_domain_params "energy") > 0 := by
  refine ⟨
    by unfold consciousness_genetics_coupling_panel_observable_count; decide,
    by unfold consciousness_genetics_coupling_panel_D_eff; decide,
