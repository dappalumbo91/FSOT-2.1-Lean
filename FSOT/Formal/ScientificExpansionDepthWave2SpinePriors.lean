...
def scientific_expansion_depth_wave2_spine_observable_count : ℕ := 40
def scientific_expansion_depth_wave2_spine_D_eff : ℕ := 11
theorem scientific_expansion_depth_wave2_spine_observable_count_pos : 0 < scientific_expansion_depth_wave2_spine_observable_count := by
  unfold scientific_expansion_depth_wave2_spine_observable_count; decide
...
theorem scientific_expansion_depth_wave2_spine_bundle :
    scientific_expansion_depth_wave2_spine_observable_count = 40 ∧
    scientific_expansion_depth_wave2_spine_D_eff = 11 ∧
    (0.0 : ℝ) < (0.5 : ℝ) ∧
    raw_S (get_domain_params "energy") > 0 := by
  refine ⟨
    by unfold scientific_expansion_depth_wave2_spine_observable_count; decide,
    by unfold scientific_expansion_depth_wave2_spine_D_eff; decide,
