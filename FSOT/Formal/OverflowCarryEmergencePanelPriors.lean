...
theorem overflow_carry_emergence_panel_observable_count_pos : 0 < overflow_carry_emergence_panel_observable_count := by
  unfold overflow_carry_emergence_panel_observable_count; norm_num
...
theorem overflow_carry_emergence_panel_bundle :
  ...
  refine ⟨
    by unfold overflow_carry_emergence_panel_observable_count; norm_num,
    by unfold overflow_carry_emergence_panel_D_eff; norm_num,
