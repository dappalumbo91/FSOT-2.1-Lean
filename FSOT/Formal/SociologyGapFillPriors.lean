...
theorem sociology_gap_fill_pooled_median_under_five_pct :
    sociology_gap_fill_pooled_median_error_pct < (5 : ℝ) := by
  unfold sociology_gap_fill_pooled_median_error_pct; norm_num

theorem sociology_gap_fill_headline_median_under_five_pct :
    sociology_gap_fill_headline_median_error_pct < (5 : ℝ) := by
...
theorem sociology_gap_fill_bundle :
    ...
    sociology_gap_fill_pooled_median_error_pct < (5 : ℝ) ∧
    sociology_gap_fill_headline_median_error_pct < (5 : ℝ) ∧
    0 < sociology_gap_fill_beats_sota_headlines ∧
    raw_S (get_domain_params "consciousness") > 0 := by
  refine ⟨
    by unfold sociology_gap_fill_observable_count; norm_num,
    sociology_gap_fill_pooled_median_under_five_pct,
    sociology_gap_fill_headline_median_under_five_pct,
