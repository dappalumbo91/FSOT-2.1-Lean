...
theorem uniprot_protein_annotations_median_error_under_half_pct :
    uniprot_protein_annotations_median_error_pct < (0.5 : ℝ) := by
...
theorem uniprot_protein_annotations_bundle :
    ...
    uniprot_protein_annotations_median_error_pct < (0.5 : ℝ) ∧
  ...
  refine ⟨
    ...
    uniprot_protein_annotations_median_error_under_half_pct,
