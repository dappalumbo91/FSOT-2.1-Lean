...
theorem agriculture_agroecology_observable_count_pos : 0 < agriculture_agroecology_observable_count := by
  unfold agriculture_agroecology_observable_count; norm_num
...
theorem agriculture_agroecology_bundle :
  ...
  refine ⟨
    by unfold agriculture_agroecology_observable_count; norm_num,
    by unfold agriculture_agroecology_D_eff; norm_num,
