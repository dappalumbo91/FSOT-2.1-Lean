...
def civil_engineering_ext_observable_count : ℕ := 37
def civil_engineering_ext_pooled_median_error_pct : ℝ := (0.0335259880736416 : ℝ)
def civil_engineering_ext_headline_median_error_pct : ℝ := (0.0335259880736416 : ℝ)
...
theorem civil_engineering_ext_pooled_median_under_five_pct :
    civil_engineering_ext_pooled_median_error_pct < (5 : ℝ) := by
  unfold civil_engineering_ext_pooled_median_error_pct; norm_num

theorem civil_engineering_ext_headline_median_under_five_pct :
    civil_engineering_ext_headline_median_error_pct < (5 : ℝ) := by
...
theorem civil_engineering_ext_bundle :
    civil_engineering_ext_observable_count = 37 ∧
    civil_engineering_ext_pooled_median_error_pct < (5 : ℝ) ∧
    civil_engineering_ext_headline_median_error_pct < (5 : ℝ) ∧
  ...
  refine ⟨
    ...
    civil_engineering_ext_pooled_median_under_five_pct,
    civil_engineering_ext_headline_median_under_five_pct,
