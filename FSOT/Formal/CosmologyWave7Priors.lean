...
theorem cosmology_wave7_observable_count_pos : 0 < cosmology_wave7_observable_count := by
  unfold cosmology_wave7_observable_count; decide
...
theorem cosmology_wave7_bundle :
    ...
    cosmology_wave7_max_error_pct < (0.5 : ℝ) ∧
    cosmology_wave7_median_error_pct < (0.5 : ℝ) ∧
    (0 : ℝ) < omega_b_h2_fsot S_cosm_cached S_quant_cached := by
  refine ⟨
    by unfold cosmology_wave7_observable_count; decide,
    cosmology_wave7_max_error_under_half_pct,
    cosmology_wave7_median_error_under_half_pct,
