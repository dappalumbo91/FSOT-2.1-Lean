...
theorem robotics_control_systems_panel_observable_count_pos : 0 < robotics_control_systems_panel_observable_count := by
  unfold robotics_control_systems_panel_observable_count; norm_num
...
theorem robotics_control_systems_panel_bundle :
  ...
  refine ⟨
    by unfold robotics_control_systems_panel_observable_count; norm_num,
    by unfold robotics_control_systems_panel_D_eff; norm_num,
