...
theorem cosmology_wave4_max_error_under_five_pct :
    cosmology_wave4_max_error_pct < (5 : ℝ) := by
  unfold cosmology_wave4_max_error_pct; norm_num

theorem cosmology_wave4_median_error_under_five_pct :
    cosmology_wave4_median_error_pct < (5 : ℝ) := by
...
theorem cosmology_wave4_bundle :
    ...
    cosmology_wave4_max_error_pct < (5 : ℝ) ∧
    cosmology_wave4_median_error_pct < (5 : ℝ) ∧
    (0 : ℝ) < omega_b_h2_fsot S_cosm_cached S_quant_cached := by
  refine ⟨
    by unfold cosmology_wave4_observable_count; norm_num,
    cosmology_wave4_max_error_under_five_pct,
    cosmology_wave4_median_error_under_five_pct,
