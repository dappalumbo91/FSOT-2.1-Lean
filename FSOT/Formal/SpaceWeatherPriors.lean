...
def space_weather_kp_record_count : ℕ := 61
def space_weather_ap_record_count : ℕ := 61
def space_weather_stability_match_count : ℕ := 58
def space_weather_D_eff : ℕ := 14
def space_weather_stability_match_rate : ℝ := (0.9508196721311475 : ℝ)
...
theorem space_weather_bundle :
    space_weather_kp_record_count = 61 ∧
    space_weather_ap_record_count = 61 ∧
    space_weather_stability_match_count = 58 ∧
