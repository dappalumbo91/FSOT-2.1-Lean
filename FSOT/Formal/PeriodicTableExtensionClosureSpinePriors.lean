...
def periodic_table_extension_closure_spine_D_eff : ℕ := 8
...
theorem periodic_table_extension_closure_spine_bundle :
    ...
    periodic_table_extension_closure_spine_D_eff = 8 ∧
    (0.0 : ℝ) < (0.5 : ℝ) ∧
    raw_S (get_domain_params "energy") > 0 := by
  refine ⟨
    by unfold periodic_table_extension_closure_spine_observable_count; decide,
    by unfold periodic_table_extension_closure_spine_D_eff; decide,
