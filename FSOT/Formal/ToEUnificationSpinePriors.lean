...
theorem toe_unification_spine_observable_count_pos : 0 < toe_unification_spine_observable_count := by
  unfold toe_unification_spine_observable_count; norm_num

theorem toe_unification_spine_median_error_under_half_pct :
    (0.01900826880249791 : ℝ) < (0.5 : ℝ) := by norm_num
...
theorem toe_unification_spine_bundle :
  ...
  refine ⟨
    by unfold toe_unification_spine_observable_count; norm_num,
    by unfold toe_unification_spine_D_eff; norm_num,
