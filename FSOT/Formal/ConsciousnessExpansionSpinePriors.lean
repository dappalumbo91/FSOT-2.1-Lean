...
def consciousness_expansion_spine_D_eff : ℕ := 9
...
theorem consciousness_expansion_spine_bundle :
    ...
    consciousness_expansion_spine_D_eff = 9 ∧
    (0.008488 : ℝ) < (0.5 : ℝ) ∧
    raw_S (get_domain_params "energy") > 0 := by
  refine ⟨
    by unfold consciousness_expansion_spine_observable_count; decide,
    by unfold consciousness_expansion_spine_D_eff; decide,
