...
| BSD-RANK | \(\mathrm{ord}\,L\) for rank \(\ge 3\) | Rank 0/1/2 are vanishing order. 643a1 raw \(L''/2!\) mis-fires as rank 4; \(\mathrm{Sha}_{\mathrm{an}}=1\). 433a1 oos. | Nearest-template special magnitude |
