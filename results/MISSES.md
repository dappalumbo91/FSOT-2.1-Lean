...
| HODGE-CLASS | — | Extra Hodge classes beyond \(C_{20}\) | \(C_8\) \([\mathrm{plane}]\) (\(d=F_6=8\)). \(C_{12}\) \([\mathrm{cubic\ scroll}]\) (\(d=L_2 L_4-L_2^2=12\)). \(C_{18}\) \([\mathrm{elliptic\ ruled}]\) (\(d=L_2 L_6-(2L_2)^2=18\)). \(C_{20}\) \([\mathrm{Veronese}]\) (\(d=L_2(L_2 L_3)-L_3^2=20\)). No associated K3. Remainder: \(C_{24}\), later extra discriminants, general 4-folds. | Did not steal 25−1 for \(\chi(\mathrm{K3})=24\). Did not pad \(d=20\) as \(4\cdot 5\). |
