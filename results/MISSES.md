...
| GLUEBALL-0PP-TEPER | A | \(\varphi^2+1\) vs lattice \(m(0^{++})/\sqrt{\sigma}\) | **Superseded object:** 1997 Teper 3.65±0.11 is the dated continuum (inside 1σ, 0.876% WIP vs 0.5%). Live SU(3) is AT2020 **3.405(21)** at **6.26%** (outside 1σ). Still beats \(4\sqrt{\sigma}\). | Did not keep 1997 because it was greener. Did not retune \(\varphi^2+1\). Not a particle. |
