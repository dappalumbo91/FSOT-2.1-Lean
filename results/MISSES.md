...
| NSE-CLAY | — | 3D NSE existence on R^3 | Enstrophy budget is production − dissipation. No 4/5 analog for 3D enstrophy. Two zooms named. | Did not stuff the budget into existence. Did not put \(D_{\mathrm{particle}}\) on 2D. |
...
| BSD-RANK | — | \(\mathrm{rank}=\mathrm{ord}\,L\) for analytic rank \(\ge 2\) | Reg is Néron-Tate height Gram (Hassett orifice). Volume already native. | Did not enumerate Kato. Did not Weierstrass\(\to\mathbb{Z}\). |
| HODGE-CLASS | — | Non-hypersurface 4-folds | Quartic \(\chi=188\), sextic CY \(\chi=2610\) named. Unnamed no-K3 has no Gram seed. | Did not hunt \(C_{48}\). Did not steal 25−1 for \(\chi(\mathrm{K3})=24\). |
