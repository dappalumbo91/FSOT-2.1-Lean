...
| HODGE-CLASS | — | Extra Hodge classes beyond \(C_{18}\) | \(C_8\) extra class is \([\mathrm{plane}]\) (\(d=F_6=8\)). \(C_{12}\) extra class is \([\mathrm{cubic\ scroll}]\) (\(d=L_2 L_4-L_2^2=12\)). \(C_{18}\) extra class is \([\mathrm{elliptic\ ruled}]\) (\(d=L_2 L_6-(2L_2)^2=18\)). No associated K3 (\(4\mid 8,12\); \(9\mid 18\)). Remainder: \(C_{20}\) Veronese, later extra discriminants, general 4-folds. | Did not steal 25−1 for \(\chi(\mathrm{K3})=24\). Did not pad \(d=8\) as \(2^3\), \(d=12\) as \(3\cdot 4\), or \(d=18\) as \(L_6\). |
