...
| GLUEBALL-F0-PAIR | A | \((\varphi^2+1)K=1.520\,\mathrm{GeV}\) vs PDG \(f_0(1500)=1506\,\mathrm{MeV}\) and \(f_0(1710)=1733\,\mathrm{MeV}\) | **0.93%** vs 1500 (WIP); **12.3%** vs 1710 (lattice GeV sits on 1710). Morningstar 2025: no scalar below ~2 GeV is predominantly glue. | Did not pick \(f_0(1500)\) because it is closer. Did not retune \(K\). Not a glueball ID. |
