...
| BSD-RANK | — | \(\mathrm{ord}\,L\) for rank \(\ge 4\) | Rank 0/1/2/3 are vanishing order. 11197a1 raw \(L'''/3!\) mis-fires as rank 4; \(\mathrm{Sha}_{\mathrm{an}}=1\). 11642a1 oos. | Did not nearest-template special magnitude. |
