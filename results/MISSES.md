...
| HODGE-CLASS | — | Extra Hodge classes beyond \(C_{30}\) | \(C_8\) through \(C_{24}\) as before. \(C_{30}\) extra class is \([\mathrm{Bl}_{10}\mathbb{P}^2]\) (Coble nodes of a rational plane sextic; \(d=30\)). No associated K3 (\(5\mid 30\), \(5\equiv 2\pmod{3}\)). Remainder: \(C_{32}\), \(C_{36}\), later extra discriminants, general 4-folds. | Did not steal 25−1 for \(\chi(\mathrm{K3})=24\). Did not pad \(d=30\) as \(5\cdot 6\). |
