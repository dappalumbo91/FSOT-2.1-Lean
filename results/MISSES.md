...
| RIEMANN-N2-10 | A | Im(ρ_n) n=2..10 \(N(T)=n\), \(C\) locked by \(e/\gamma^3\) | **Superseded object:** 1.63% was GUE jitter scored as a point miss of smooth counting. Two systems (like 1997 vs AT2020). Odlyzko **10/10 inside** the 1/e Gram band \(\Delta T=2\pi(1/e)/\log(T/2\pi)\). Mean occupancy 0.41. | Did not trig-stuff S(n). Did not restore 7/8. Not RH. |
