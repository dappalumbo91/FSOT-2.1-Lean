...
## Verification status (2026-07-10 — Tier 77)
...
| Extension domains | **245/245** pass `verify_extension_domains.py` (≤0.5% pooled gate) |
| Scientific domains | **281** (35 NeuroLab + 245 extension + Intelligence Compression rollup) |
