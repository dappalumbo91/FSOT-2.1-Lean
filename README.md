...
## Verification status (2026-07-10 — Tier 72)
...
| Extension domains | **220/220** pass `verify_extension_domains.py` (≤0.5% pooled gate) |
| Scientific domains | **256** (35 NeuroLab + 220 extension + Intelligence Compression rollup) |
