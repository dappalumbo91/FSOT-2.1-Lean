...
def _detect_cells_pooled_scored(
    ...
    """Like _detect_cells_pooled but also returns sigmoid confidence per peak."""
...
def predict_video(
    ...
    det_conf_parts: list[np.ndarray] | None = None,
