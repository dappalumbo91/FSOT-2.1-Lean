...
def run_millennium_suite() -> list[dict[str, Any]]:
    ...
    for name, note in (
        ...
        ("hodge_clay_open", "Algebraic cycles vs cohomology. Associated K3 reduces cubic (2,2) to Lefschetz (1,1). C_8 [plane], C_12 [scroll], C_18 [elliptic ruled], C_20 [Veronese] extra classes algebraic. Remainder: later extra discriminants, general 4-folds."),
    ):
        rows.append(
            _row(
                name,
