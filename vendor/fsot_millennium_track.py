...
def run_millennium_suite() -> list[dict[str, Any]]:
    ...
    for name, note in (
        ("bsd_clay_open", "Rank vs L-function. Parity from w_E. First-curve leadings label ranks 0..4. LMFDB ranks 0..5 are vanishing order (Sha=1). Rank ≥6 is the unnamed tail (outside LMFDB). General E still produces the leading from its modular form."),
